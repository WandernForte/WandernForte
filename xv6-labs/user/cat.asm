...
cat(int fd)
{
  ...
  14:	a1090913          	addi	s2,s2,-1520 # a20 <buf>
  ...
  44:	8f058593          	addi	a1,a1,-1808 # 930 <statistics+0x86>
  48:	4509                	li	a0,2
  ...
  72:	8da58593          	addi	a1,a1,-1830 # 948 <statistics+0x9e>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	85e58593          	addi	a1,a1,-1954 # 960 <statistics+0xb6>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47a:	56250513          	addi	a0,a0,1378 # 9d8 <digits>
 47e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53a:	44ac8c93          	addi	s9,s9,1098 # 980 <statistics+0xd6>
 ...
 548:	494b8b93          	addi	s7,s7,1172 # 9d8 <digits>
 ...
 66e:	30e98993          	addi	s3,s3,782 # 978 <statistics+0xce>
        while(*s != 0){
 672:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 750:	2cc7b783          	ld	a5,716(a5) # a18 <freep>
 ...
 778:	00e6ea63          	bltu	a3,a4,78c <free+0x4a>
{
 ...
 7ba:	26f73123          	sd	a5,610(a4) # a18 <freep>
}
 7be:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ec:	23053503          	ld	a0,560(a0) # a18 <freep>
 ...
 814:	20890913          	addi	s2,s2,520 # a18 <freep>
  if(p == (char*)-1)
 818:	5afd                	li	s5,-1
 81a:	a895                	j	88e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 81c:	00000797          	auipc	a5,0x0
 820:	40478793          	addi	a5,a5,1028 # c20 <base>
 824:	00000717          	auipc	a4,0x0
 828:	1ef73a23          	sd	a5,500(a4) # a18 <freep>
 82c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 850:	1ca73623          	sd	a0,460(a4) # a18 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8c4:	13050513          	addi	a0,a0,304 # 9f0 <digits+0x18>
 8c8:	00000097          	auipc	ra,0x0
 8cc:	b02080e7          	jalr	-1278(ra) # 3ca <open>
  if(fd < 0) {
 ...
 8ea:	abc080e7          	jalr	-1348(ra) # 3a2 <read>
 ...
 8fe:	ab8080e7          	jalr	-1352(ra) # 3b2 <close>
  return i;
}
 902:	8526                	mv	a0,s1
 ...
 918:	0ec58593          	addi	a1,a1,236 # a00 <digits+0x28>
 91c:	4509                	li	a0,2
 ...
 92c:	a62080e7          	jalr	-1438(ra) # 38a <exit>
