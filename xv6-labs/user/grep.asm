...
000000000000011a <grep>:
{
 ...
 13e:	a56a8a93          	addi	s5,s5,-1450 # b90 <buf>
...
00000000000001de <main>:
{
 ...
 252:	86258593          	addi	a1,a1,-1950 # ab0 <statistics+0x86>
 256:	4509                	li	a0,2
 ...
 288:	84c50513          	addi	a0,a0,-1972 # ad0 <statistics+0xa6>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ba:	43ac8c93          	addi	s9,s9,1082 # af0 <statistics+0xc6>
 ...
 6c8:	484b8b93          	addi	s7,s7,1156 # b48 <digits>
 ...
 7ee:	2fe98993          	addi	s3,s3,766 # ae8 <statistics+0xbe>
        while(*s != 0){
 7f2:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 8d0:	2bc7b783          	ld	a5,700(a5) # b88 <freep>
 ...
 8f8:	00e6ea63          	bltu	a3,a4,90c <free+0x4a>
{
 ...
 93a:	24f73923          	sd	a5,594(a4) # b88 <freep>
}
 93e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 96c:	22053503          	ld	a0,544(a0) # b88 <freep>
 ...
 994:	1f890913          	addi	s2,s2,504 # b88 <freep>
  if(p == (char*)-1)
 998:	5afd                	li	s5,-1
 99a:	a895                	j	a0e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 99c:	00000797          	auipc	a5,0x0
 9a0:	5f478793          	addi	a5,a5,1524 # f90 <base>
 9a4:	00000717          	auipc	a4,0x0
 9a8:	1ef73223          	sd	a5,484(a4) # b88 <freep>
 9ac:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9d0:	1aa73e23          	sd	a0,444(a4) # b88 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 a44:	12050513          	addi	a0,a0,288 # b60 <digits+0x18>
 a48:	00000097          	auipc	ra,0x0
 a4c:	b02080e7          	jalr	-1278(ra) # 54a <open>
  if(fd < 0) {
 a50:	04054263          	bltz	a0,a94 <statistics+0x6a>
 a54:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 a56:	4481                	li	s1,0
 a58:	03205063          	blez	s2,a78 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 a5c:	4099063b          	subw	a2,s2,s1
 a60:	009a05b3          	add	a1,s4,s1
 a64:	854e                	mv	a0,s3
 a66:	00000097          	auipc	ra,0x0
 a6a:	abc080e7          	jalr	-1348(ra) # 522 <read>
 a6e:	00054563          	bltz	a0,a78 <statistics+0x4e>
      break;
    }
    i += n;
 a72:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 a74:	ff24c4e3          	blt	s1,s2,a5c <statistics+0x32>
  }
  close(fd);
 a78:	854e                	mv	a0,s3
 a7a:	00000097          	auipc	ra,0x0
 a7e:	ab8080e7          	jalr	-1352(ra) # 532 <close>
  return i;
}
 a82:	8526                	mv	a0,s1
 ...
 a8a:	6942                	ld	s2,16(sp)
 a8c:	69a2                	ld	s3,8(sp)
 a8e:	6a02                	ld	s4,0(sp)
 a90:	6145                	addi	sp,sp,48
 a92:	8082                	ret
      fprintf(2, "stats: open failed\n");
 a94:	00000597          	auipc	a1,0x0
 a98:	0dc58593          	addi	a1,a1,220 # b70 <digits+0x28>
 a9c:	4509                	li	a0,2
 a9e:	00000097          	auipc	ra,0x0
 aa2:	dc0080e7          	jalr	-576(ra) # 85e <fprintf>
      exit(1);
 aa6:	4505                	li	a0,1
 aa8:	00000097          	auipc	ra,0x0
 aac:	a62080e7          	jalr	-1438(ra) # 50a <exit>
