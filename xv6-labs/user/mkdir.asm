...
main(int argc, char *argv[])
{
  ...
  42:	85258593          	addi	a1,a1,-1966 # 890 <statistics+0x8c>
  46:	4509                	li	a0,2
  ...
  60:	84c58593          	addi	a1,a1,-1972 # 8a8 <statistics+0xa4>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d4:	55850513          	addi	a0,a0,1368 # 928 <digits>
 3d8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 494:	440c8c93          	addi	s9,s9,1088 # 8d0 <statistics+0xcc>
 ...
 4a2:	48ab8b93          	addi	s7,s7,1162 # 928 <digits>
 ...
 5c8:	30498993          	addi	s3,s3,772 # 8c8 <statistics+0xc4>
        while(*s != 0){
 5cc:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6aa:	2c27b783          	ld	a5,706(a5) # 968 <freep>
 ...
 6d2:	00e6ea63          	bltu	a3,a4,6e6 <free+0x4a>
{
 ...
 714:	24f73c23          	sd	a5,600(a4) # 968 <freep>
}
 718:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 746:	22653503          	ld	a0,550(a0) # 968 <freep>
 ...
 76e:	1fe90913          	addi	s2,s2,510 # 968 <freep>
  if(p == (char*)-1)
 772:	5afd                	li	s5,-1
 774:	a895                	j	7e8 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 776:	00000797          	auipc	a5,0x0
 77a:	1fa78793          	addi	a5,a5,506 # 970 <base>
 77e:	00000717          	auipc	a4,0x0
 782:	1ef73523          	sd	a5,490(a4) # 968 <freep>
 786:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7aa:	1ca73123          	sd	a0,450(a4) # 968 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 81e:	12650513          	addi	a0,a0,294 # 940 <digits+0x18>
 822:	00000097          	auipc	ra,0x0
 826:	b02080e7          	jalr	-1278(ra) # 324 <open>
  if(fd < 0) {
 82a:	04054263          	bltz	a0,86e <statistics+0x6a>
 82e:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 830:	4481                	li	s1,0
 832:	03205063          	blez	s2,852 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 836:	4099063b          	subw	a2,s2,s1
 83a:	009a05b3          	add	a1,s4,s1
 83e:	854e                	mv	a0,s3
 840:	00000097          	auipc	ra,0x0
 844:	abc080e7          	jalr	-1348(ra) # 2fc <read>
 848:	00054563          	bltz	a0,852 <statistics+0x4e>
      break;
    }
    i += n;
 84c:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 84e:	ff24c4e3          	blt	s1,s2,836 <statistics+0x32>
  }
  close(fd);
 852:	854e                	mv	a0,s3
 854:	00000097          	auipc	ra,0x0
 858:	ab8080e7          	jalr	-1352(ra) # 30c <close>
  return i;
}
 85c:	8526                	mv	a0,s1
 85e:	70a2                	ld	ra,40(sp)
 860:	7402                	ld	s0,32(sp)
 862:	64e2                	ld	s1,24(sp)
 864:	6942                	ld	s2,16(sp)
 866:	69a2                	ld	s3,8(sp)
 868:	6a02                	ld	s4,0(sp)
 86a:	6145                	addi	sp,sp,48
 86c:	8082                	ret
      fprintf(2, "stats: open failed\n");
 86e:	00000597          	auipc	a1,0x0
 872:	0e258593          	addi	a1,a1,226 # 950 <digits+0x28>
 876:	4509                	li	a0,2
 878:	00000097          	auipc	ra,0x0
 87c:	dc0080e7          	jalr	-576(ra) # 638 <fprintf>
      exit(1);
 880:	4505                	li	a0,1
 882:	00000097          	auipc	ra,0x0
 886:	a62080e7          	jalr	-1438(ra) # 2e4 <exit>
