...
main(void)
{
  ...
  de:	95e58593          	addi	a1,a1,-1698 # a38 <argv>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 468:	5a450513          	addi	a0,a0,1444 # a08 <digits>
 46c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 528:	48cc8c93          	addi	s9,s9,1164 # 9b0 <statistics+0x118>
 ...
 536:	4d6b8b93          	addi	s7,s7,1238 # a08 <digits>
 ...
 65c:	35098993          	addi	s3,s3,848 # 9a8 <statistics+0x110>
        while(*s != 0){
 660:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 73e:	30e7b783          	ld	a5,782(a5) # a48 <freep>
 ...
 766:	00e6ea63          	bltu	a3,a4,77a <free+0x4a>
{
 ...
 7a8:	2af73223          	sd	a5,676(a4) # a48 <freep>
}
 7ac:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7da:	27253503          	ld	a0,626(a0) # a48 <freep>
 ...
 802:	24a90913          	addi	s2,s2,586 # a48 <freep>
  if(p == (char*)-1)
 806:	5afd                	li	s5,-1
 808:	a895                	j	87c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 80a:	00000797          	auipc	a5,0x0
 80e:	24678793          	addi	a5,a5,582 # a50 <base>
 812:	00000717          	auipc	a4,0x0
 816:	22f73b23          	sd	a5,566(a4) # a48 <freep>
 81a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 83e:	20a73723          	sd	a0,526(a4) # a48 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8ba:	b02080e7          	jalr	-1278(ra) # 3b8 <open>
  if(fd < 0) {
 ...
 8d8:	abc080e7          	jalr	-1348(ra) # 390 <read>
 ...
 8ec:	ab8080e7          	jalr	-1352(ra) # 3a0 <close>
  return i;
}
 8f0:	8526                	mv	a0,s1
 ...
 91a:	a62080e7          	jalr	-1438(ra) # 378 <exit>
