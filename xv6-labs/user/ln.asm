...
main(int argc, char *argv[])
{
  ...
  14:	86858593          	addi	a1,a1,-1944 # 878 <statistics+0x8c>
  18:	4509                	li	a0,2
  ...
  50:	84458593          	addi	a1,a1,-1980 # 890 <statistics+0xa4>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bc:	55050513          	addi	a0,a0,1360 # 908 <digits>
 3c0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 47c:	438c8c93          	addi	s9,s9,1080 # 8b0 <statistics+0xc4>
 ...
 48a:	482b8b93          	addi	s7,s7,1154 # 908 <digits>
 ...
 5b0:	2fc98993          	addi	s3,s3,764 # 8a8 <statistics+0xbc>
        while(*s != 0){
 5b4:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 692:	2ba7b783          	ld	a5,698(a5) # 948 <freep>
 ...
 6ba:	00e6ea63          	bltu	a3,a4,6ce <free+0x4a>
{
 ...
 6fc:	24f73823          	sd	a5,592(a4) # 948 <freep>
}
 700:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 72e:	21e53503          	ld	a0,542(a0) # 948 <freep>
 ...
 756:	1f690913          	addi	s2,s2,502 # 948 <freep>
  if(p == (char*)-1)
 75a:	5afd                	li	s5,-1
 75c:	a895                	j	7d0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 75e:	00000797          	auipc	a5,0x0
 762:	1f278793          	addi	a5,a5,498 # 950 <base>
 766:	00000717          	auipc	a4,0x0
 76a:	1ef73123          	sd	a5,482(a4) # 948 <freep>
 76e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 792:	1aa73d23          	sd	a0,442(a4) # 948 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 806:	11e50513          	addi	a0,a0,286 # 920 <digits+0x18>
 80a:	00000097          	auipc	ra,0x0
 80e:	b02080e7          	jalr	-1278(ra) # 30c <open>
  if(fd < 0) {
 ...
 82c:	abc080e7          	jalr	-1348(ra) # 2e4 <read>
 ...
 840:	ab8080e7          	jalr	-1352(ra) # 2f4 <close>
  return i;
}
 844:	8526                	mv	a0,s1
 ...
 85a:	0da58593          	addi	a1,a1,218 # 930 <digits+0x28>
 85e:	4509                	li	a0,2
 ...
 86e:	a62080e7          	jalr	-1438(ra) # 2cc <exit>
