...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	8d250513          	addi	a0,a0,-1838 # 5910 <statistics+0x86>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	0c878793          	addi	a5,a5,200 # 9120 <uninit>
      60:	0000b697          	auipc	a3,0xb
      64:	7d068693          	addi	a3,a3,2000 # b830 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	8b050513          	addi	a0,a0,-1872 # 5930 <statistics+0xa6>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	8a050513          	addi	a0,a0,-1888 # 5948 <statistics+0xbe>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	8a250513          	addi	a0,a0,-1886 # 5968 <statistics+0xde>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	86a50513          	addi	a0,a0,-1942 # 5950 <statistics+0xc6>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	87650513          	addi	a0,a0,-1930 # 5978 <statistics+0xee>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	87450513          	addi	a0,a0,-1932 # 59a0 <statistics+0x116>
     134:	00005097          	auipc	ra,0x5
     138:	286080e7          	jalr	646(ra) # 53ba <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	86050513          	addi	a0,a0,-1952 # 59a0 <statistics+0x116>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	85c58593          	addi	a1,a1,-1956 # 59b0 <statistics+0x126>
     15c:	00005097          	auipc	ra,0x5
     160:	22e080e7          	jalr	558(ra) # 538a <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	83850513          	addi	a0,a0,-1992 # 59a0 <statistics+0x116>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	83c58593          	addi	a1,a1,-1988 # 59b8 <statistics+0x12e>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	80c50513          	addi	a0,a0,-2036 # 59a0 <statistics+0x116>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	7f650513          	addi	a0,a0,2038 # 59c0 <statistics+0x136>
...
00000000000001e4 <createtest>:
{
  ...
  name[0] = 'a';
     ...
     1f6:	e1678793          	addi	a5,a5,-490 # 8008 <name>
  ...
  name[0] = 'a';
     ...
     238:	dd478793          	addi	a5,a5,-556 # 8008 <name>
...
0000000000000278 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     294:	75850513          	addi	a0,a0,1880 # 59e8 <statistics+0x15e>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2a8:	744a8a93          	addi	s5,s5,1860 # 59e8 <statistics+0x15e>
      int cc = write(fd, buf, sz);
     2ac:	0000ba17          	auipc	s4,0xb
     2b0:	584a0a13          	addi	s4,s4,1412 # b830 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2b4:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     32a:	6d250513          	addi	a0,a0,1746 # 59f8 <statistics+0x16e>
     ...
     34c:	6d050513          	addi	a0,a0,1744 # 5a18 <statistics+0x18e>
     350:	00005097          	auipc	ra,0x5
     354:	39c080e7          	jalr	924(ra) # 56ec <printf>
        exit(1);
     358:	4505                	li	a0,1
...
0000000000000362 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     388:	6aca0a13          	addi	s4,s4,1708 # 5a30 <statistics+0x1a6>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     434:	60850513          	addi	a0,a0,1544 # 5a38 <statistics+0x1ae>
     438:	00005097          	auipc	ra,0x5
     43c:	2b4080e7          	jalr	692(ra) # 56ec <printf>
      exit(1);
     440:	4505                	li	a0,1
     ...
     452:	60250513          	addi	a0,a0,1538 # 5a50 <statistics+0x1c6>
     456:	00005097          	auipc	ra,0x5
     45a:	296080e7          	jalr	662(ra) # 56ec <printf>
      exit(1);
     45e:	4505                	li	a0,1
     ...
     470:	61450513          	addi	a0,a0,1556 # 5a80 <statistics+0x1f6>
     474:	00005097          	auipc	ra,0x5
     478:	278080e7          	jalr	632(ra) # 56ec <printf>
      exit(1);
     47c:	4505                	li	a0,1
     ...
     48a:	62a50513          	addi	a0,a0,1578 # 5ab0 <statistics+0x226>
     48e:	00005097          	auipc	ra,0x5
     492:	25e080e7          	jalr	606(ra) # 56ec <printf>
      exit(1);
     496:	4505                	li	a0,1
     ...
     4a8:	61c50513          	addi	a0,a0,1564 # 5ac0 <statistics+0x236>
     4ac:	00005097          	auipc	ra,0x5
     4b0:	240080e7          	jalr	576(ra) # 56ec <printf>
      exit(1);
     4b4:	4505                	li	a0,1
...
00000000000004be <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4e6:	60ea0a13          	addi	s4,s4,1550 # 5af0 <statistics+0x266>
    n = write(fds[1], "x", 1);
     4ea:	00005a97          	auipc	s5,0x5
     4ee:	4cea8a93          	addi	s5,s5,1230 # 59b8 <statistics+0x12e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     594:	56850513          	addi	a0,a0,1384 # 5af8 <statistics+0x26e>
     598:	00005097          	auipc	ra,0x5
     59c:	154080e7          	jalr	340(ra) # 56ec <printf>
      exit(1);
     5a0:	4505                	li	a0,1
     ...
     5b2:	56250513          	addi	a0,a0,1378 # 5b10 <statistics+0x286>
     5b6:	00005097          	auipc	ra,0x5
     5ba:	136080e7          	jalr	310(ra) # 56ec <printf>
      exit(1);
     5be:	4505                	li	a0,1
     ...
     5cc:	4e850513          	addi	a0,a0,1256 # 5ab0 <statistics+0x226>
     5d0:	00005097          	auipc	ra,0x5
     5d4:	11c080e7          	jalr	284(ra) # 56ec <printf>
      exit(1);
     5d8:	4505                	li	a0,1
     ...
     5e6:	55e50513          	addi	a0,a0,1374 # 5b40 <statistics+0x2b6>
     5ea:	00005097          	auipc	ra,0x5
     5ee:	102080e7          	jalr	258(ra) # 56ec <printf>
      exit(1);
     5f2:	4505                	li	a0,1
     ...
     604:	55850513          	addi	a0,a0,1368 # 5b58 <statistics+0x2ce>
     608:	00005097          	auipc	ra,0x5
     60c:	0e4080e7          	jalr	228(ra) # 56ec <printf>
      exit(1);
     610:	4505                	li	a0,1
...
000000000000061a <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     65a:	35a58593          	addi	a1,a1,858 # 59b0 <statistics+0x126>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     676:	32e50513          	addi	a0,a0,814 # 59a0 <statistics+0x116>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     6a2:	30250513          	addi	a0,a0,770 # 59a0 <statistics+0x116>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6b6:	2ee50513          	addi	a0,a0,750 # 59a0 <statistics+0x116>
  ...
  write(fd1, "abcdef", 6);
     ...
     6f4:	4f858593          	addi	a1,a1,1272 # 5be8 <statistics+0x35e>
     6f8:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     736:	26e50513          	addi	a0,a0,622 # 59a0 <statistics+0x116>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     77a:	41250513          	addi	a0,a0,1042 # 5b88 <statistics+0x2fe>
     77e:	00005097          	auipc	ra,0x5
     782:	f6e080e7          	jalr	-146(ra) # 56ec <printf>
    exit(1);
     786:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     796:	41650513          	addi	a0,a0,1046 # 5ba8 <statistics+0x31e>
     79a:	00005097          	auipc	ra,0x5
     79e:	f52080e7          	jalr	-174(ra) # 56ec <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7a2:	8652                	mv	a2,s4
     7a4:	85d6                	mv	a1,s5
     7a6:	00005517          	auipc	a0,0x5
     7aa:	41250513          	addi	a0,a0,1042 # 5bb8 <statistics+0x32e>
     7ae:	00005097          	auipc	ra,0x5
     7b2:	f3e080e7          	jalr	-194(ra) # 56ec <printf>
    exit(1);
     7b6:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7c6:	41650513          	addi	a0,a0,1046 # 5bd8 <statistics+0x34e>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	f22080e7          	jalr	-222(ra) # 56ec <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7d2:	8652                	mv	a2,s4
     7d4:	85d6                	mv	a1,s5
     7d6:	00005517          	auipc	a0,0x5
     7da:	3e250513          	addi	a0,a0,994 # 5bb8 <statistics+0x32e>
     7de:	00005097          	auipc	ra,0x5
     7e2:	f0e080e7          	jalr	-242(ra) # 56ec <printf>
    exit(1);
     7e6:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7f8:	3fc50513          	addi	a0,a0,1020 # 5bf0 <statistics+0x366>
     7fc:	00005097          	auipc	ra,0x5
     800:	ef0080e7          	jalr	-272(ra) # 56ec <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     816:	3fe50513          	addi	a0,a0,1022 # 5c10 <statistics+0x386>
     81a:	00005097          	auipc	ra,0x5
     81e:	ed2080e7          	jalr	-302(ra) # 56ec <printf>
    exit(1);
     822:	4505                	li	a0,1
...
000000000000082c <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     84a:	3ea50513          	addi	a0,a0,1002 # 5c30 <statistics+0x3a6>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     862:	3fa98993          	addi	s3,s3,1018 # 5c58 <statistics+0x3ce>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     866:	00005a97          	auipc	s5,0x5
     86a:	42aa8a93          	addi	s5,s5,1066 # 5c90 <statistics+0x406>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8b0:	38450513          	addi	a0,a0,900 # 5c30 <statistics+0x3a6>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8ca:	f6a58593          	addi	a1,a1,-150 # b830 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8ec:	34850513          	addi	a0,a0,840 # 5c30 <statistics+0x3a6>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     916:	32650513          	addi	a0,a0,806 # 5c38 <statistics+0x3ae>
     91a:	00005097          	auipc	ra,0x5
     91e:	dd2080e7          	jalr	-558(ra) # 56ec <printf>
    exit(1);
     922:	4505                	li	a0,1
     ...
     932:	33a50513          	addi	a0,a0,826 # 5c68 <statistics+0x3de>
     936:	00005097          	auipc	ra,0x5
     93a:	db6080e7          	jalr	-586(ra) # 56ec <printf>
      exit(1);
     93e:	4505                	li	a0,1
     ...
     94e:	35650513          	addi	a0,a0,854 # 5ca0 <statistics+0x416>
     952:	00005097          	auipc	ra,0x5
     956:	d9a080e7          	jalr	-614(ra) # 56ec <printf>
      exit(1);
     95a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     96a:	36250513          	addi	a0,a0,866 # 5cc8 <statistics+0x43e>
     96e:	00005097          	auipc	ra,0x5
     972:	d7e080e7          	jalr	-642(ra) # 56ec <printf>
    exit(1);
     976:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     986:	36650513          	addi	a0,a0,870 # 5ce8 <statistics+0x45e>
     98a:	00005097          	auipc	ra,0x5
     98e:	d62080e7          	jalr	-670(ra) # 56ec <printf>
    exit(1);
     992:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9a2:	36250513          	addi	a0,a0,866 # 5d00 <statistics+0x476>
     9a6:	00005097          	auipc	ra,0x5
     9aa:	d46080e7          	jalr	-698(ra) # 56ec <printf>
    exit(1);
     9ae:	4505                	li	a0,1
...
00000000000009b8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9d4:	35050513          	addi	a0,a0,848 # 5d20 <statistics+0x496>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9e8:	e4c90913          	addi	s2,s2,-436 # b830 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a26:	2fe50513          	addi	a0,a0,766 # 5d20 <statistics+0x496>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a3a:	dfa90913          	addi	s2,s2,-518 # b830 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a6e:	2be50513          	addi	a0,a0,702 # 5d28 <statistics+0x49e>
     a72:	00005097          	auipc	ra,0x5
     a76:	c7a080e7          	jalr	-902(ra) # 56ec <printf>
    exit(1);
     a7a:	4505                	li	a0,1
     ...
     a8a:	2c250513          	addi	a0,a0,706 # 5d48 <statistics+0x4be>
     a8e:	00005097          	auipc	ra,0x5
     a92:	c5e080e7          	jalr	-930(ra) # 56ec <printf>
      exit(1);
     a96:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     aa6:	2ce50513          	addi	a0,a0,718 # 5d70 <statistics+0x4e6>
     aaa:	00005097          	auipc	ra,0x5
     aae:	c42080e7          	jalr	-958(ra) # 56ec <printf>
    exit(1);
     ab2:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ad2:	25250513          	addi	a0,a0,594 # 5d20 <statistics+0x496>
     ...
     afc:	29850513          	addi	a0,a0,664 # 5d90 <statistics+0x506>
     b00:	00005097          	auipc	ra,0x5
     b04:	bec080e7          	jalr	-1044(ra) # 56ec <printf>
        exit(1);
     b08:	4505                	li	a0,1
     ...
     b18:	2a450513          	addi	a0,a0,676 # 5db8 <statistics+0x52e>
     b1c:	00005097          	auipc	ra,0x5
     b20:	bd0080e7          	jalr	-1072(ra) # 56ec <printf>
      exit(1);
     b24:	4505                	li	a0,1
     ...
     b34:	2a050513          	addi	a0,a0,672 # 5dd0 <statistics+0x546>
     b38:	00005097          	auipc	ra,0x5
     b3c:	bb4080e7          	jalr	-1100(ra) # 56ec <printf>
      exit(1);
     b40:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b50:	2ac50513          	addi	a0,a0,684 # 5df8 <statistics+0x56e>
     b54:	00005097          	auipc	ra,0x5
     b58:	b98080e7          	jalr	-1128(ra) # 56ec <printf>
    exit(1);
     b5c:	4505                	li	a0,1
...
0000000000000b66 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b7e:	29650513          	addi	a0,a0,662 # 5e10 <statistics+0x586>
  ...
  write(fd, "hello", SZ);
     ...
     b96:	2ae58593          	addi	a1,a1,686 # 5e40 <statistics+0x5b6>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb2:	26250513          	addi	a0,a0,610 # 5e10 <statistics+0x586>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc8:	24c50513          	addi	a0,a0,588 # 5e10 <statistics+0x586>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bde:	23650513          	addi	a0,a0,566 # 5e10 <statistics+0x586>
  ...
  write(fd1, "yyy", 3);
     ...
     bf2:	29a58593          	addi	a1,a1,666 # 5e88 <statistics+0x5fe>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c0e:	c2658593          	addi	a1,a1,-986 # b830 <buf>
     c12:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c5a:	1ba50513          	addi	a0,a0,442 # 5e10 <statistics+0x586>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c7a:	1aa50513          	addi	a0,a0,426 # 5e20 <statistics+0x596>
     c7e:	00005097          	auipc	ra,0x5
     c82:	a6e080e7          	jalr	-1426(ra) # 56ec <printf>
    exit(1);
     c86:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c96:	1b650513          	addi	a0,a0,438 # 5e48 <statistics+0x5be>
     c9a:	00005097          	auipc	ra,0x5
     c9e:	a52080e7          	jalr	-1454(ra) # 56ec <printf>
    exit(1);
     ca2:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cb2:	1ba50513          	addi	a0,a0,442 # 5e68 <statistics+0x5de>
     cb6:	00005097          	auipc	ra,0x5
     cba:	a36080e7          	jalr	-1482(ra) # 56ec <printf>
    exit(1);
     cbe:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cce:	1c650513          	addi	a0,a0,454 # 5e90 <statistics+0x606>
     cd2:	00005097          	auipc	ra,0x5
     cd6:	a1a080e7          	jalr	-1510(ra) # 56ec <printf>
    exit(1);
     cda:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     cea:	1ca50513          	addi	a0,a0,458 # 5eb0 <statistics+0x626>
     cee:	00005097          	auipc	ra,0x5
     cf2:	9fe080e7          	jalr	-1538(ra) # 56ec <printf>
    exit(1);
     cf6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d06:	1ce50513          	addi	a0,a0,462 # 5ed0 <statistics+0x646>
     d0a:	00005097          	auipc	ra,0x5
     d0e:	9e2080e7          	jalr	-1566(ra) # 56ec <printf>
    exit(1);
     d12:	4505                	li	a0,1
...
0000000000000d1c <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d6a:	0da58593          	addi	a1,a1,218 # 5e40 <statistics+0x5b6>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d8a:	17258593          	addi	a1,a1,370 # 5ef8 <statistics+0x66e>
     d8e:	00005517          	auipc	a0,0x5
     d92:	16250513          	addi	a0,a0,354 # 5ef0 <statistics+0x666>
  ...
  unlink("lf1");
     ...
     da6:	14e50513          	addi	a0,a0,334 # 5ef0 <statistics+0x666>
     daa:	00004097          	auipc	ra,0x4
     dae:	610080e7          	jalr	1552(ra) # 53ba <unlink>
  if(open("lf1", 0) >= 0){
     db2:	4581                	li	a1,0
     db4:	00005517          	auipc	a0,0x5
     db8:	13c50513          	addi	a0,a0,316 # 5ef0 <statistics+0x666>
  ...
  fd = open("lf2", 0);
     ...
     dce:	12e50513          	addi	a0,a0,302 # 5ef8 <statistics+0x66e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de6:	a4e58593          	addi	a1,a1,-1458 # b830 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e06:	0f658593          	addi	a1,a1,246 # 5ef8 <statistics+0x66e>
     e0a:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e1c:	0e050513          	addi	a0,a0,224 # 5ef8 <statistics+0x66e>
     e20:	00004097          	auipc	ra,0x4
     e24:	59a080e7          	jalr	1434(ra) # 53ba <unlink>
  if(link("lf2", "lf1") >= 0){
     e28:	00005597          	auipc	a1,0x5
     e2c:	0c858593          	addi	a1,a1,200 # 5ef0 <statistics+0x666>
     e30:	00005517          	auipc	a0,0x5
     e34:	0c850513          	addi	a0,a0,200 # 5ef8 <statistics+0x66e>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e48:	0ac58593          	addi	a1,a1,172 # 5ef0 <statistics+0x666>
     e4c:	00005517          	auipc	a0,0x5
     e50:	1b450513          	addi	a0,a0,436 # 6000 <statistics+0x776>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e72:	09250513          	addi	a0,a0,146 # 5f00 <statistics+0x676>
     e76:	00005097          	auipc	ra,0x5
     e7a:	876080e7          	jalr	-1930(ra) # 56ec <printf>
    exit(1);
     e7e:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e8e:	08e50513          	addi	a0,a0,142 # 5f18 <statistics+0x68e>
     e92:	00005097          	auipc	ra,0x5
     e96:	85a080e7          	jalr	-1958(ra) # 56ec <printf>
    exit(1);
     e9a:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     eaa:	08a50513          	addi	a0,a0,138 # 5f30 <statistics+0x6a6>
     eae:	00005097          	auipc	ra,0x5
     eb2:	83e080e7          	jalr	-1986(ra) # 56ec <printf>
    exit(1);
     eb6:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec6:	08e50513          	addi	a0,a0,142 # 5f50 <statistics+0x6c6>
     eca:	00005097          	auipc	ra,0x5
     ece:	822080e7          	jalr	-2014(ra) # 56ec <printf>
    exit(1);
     ed2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     ee2:	0a250513          	addi	a0,a0,162 # 5f80 <statistics+0x6f6>
     ee6:	00005097          	auipc	ra,0x5
     eea:	806080e7          	jalr	-2042(ra) # 56ec <printf>
    exit(1);
     eee:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     efe:	09e50513          	addi	a0,a0,158 # 5f98 <statistics+0x70e>
     f02:	00004097          	auipc	ra,0x4
     f06:	7ea080e7          	jalr	2026(ra) # 56ec <printf>
    exit(1);
     f0a:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f1a:	09a50513          	addi	a0,a0,154 # 5fb0 <statistics+0x726>
     f1e:	00004097          	auipc	ra,0x4
     f22:	7ce080e7          	jalr	1998(ra) # 56ec <printf>
    exit(1);
     f26:	4505                	li	a0,1
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f36:	0a650513          	addi	a0,a0,166 # 5fd8 <statistics+0x74e>
     f3a:	00004097          	auipc	ra,0x4
     f3e:	7b2080e7          	jalr	1970(ra) # 56ec <printf>
    exit(1);
     f42:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f52:	0ba50513          	addi	a0,a0,186 # 6008 <statistics+0x77e>
     f56:	00004097          	auipc	ra,0x4
     f5a:	796080e7          	jalr	1942(ra) # 56ec <printf>
    exit(1);
     f5e:	4505                	li	a0,1
...
0000000000000f68 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb8:	074a0a13          	addi	s4,s4,116 # 6028 <statistics+0x79e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    100a:	02250513          	addi	a0,a0,34 # 6028 <statistics+0x79e>
  ...
  for(i = 0; i < N; i++){
    ...
    107a:	fba50513          	addi	a0,a0,-70 # 6030 <statistics+0x7a6>
    107e:	00004097          	auipc	ra,0x4
    1082:	66e080e7          	jalr	1646(ra) # 56ec <printf>
    exit(1);
    1086:	4505                	li	a0,1
    ...
    109a:	fba50513          	addi	a0,a0,-70 # 6050 <statistics+0x7c6>
    109e:	00004097          	auipc	ra,0x4
    10a2:	64e080e7          	jalr	1614(ra) # 56ec <printf>
      exit(1);
    10a6:	4505                	li	a0,1
    ...
    10b6:	fbe50513          	addi	a0,a0,-66 # 6070 <statistics+0x7e6>
    10ba:	00004097          	auipc	ra,0x4
    10be:	632080e7          	jalr	1586(ra) # 56ec <printf>
      exit(1);
    10c2:	4505                	li	a0,1
...
00000000000010cc <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e8:	fac98993          	addi	s3,s3,-84 # 6090 <statistics+0x806>
    10ec:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1124:	f8050513          	addi	a0,a0,-128 # 60a0 <statistics+0x816>
    1128:	00004097          	auipc	ra,0x4
    112c:	5c4080e7          	jalr	1476(ra) # 56ec <printf>
      exit(1);
    1130:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    114c:	eb04b483          	ld	s1,-336(s1) # 7ff8 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    1182:	35048493          	addi	s1,s1,848 # c350 <buf+0xb20>
  for(int i = 0; i < 50000; i++){
    ...
    1190:	7bc98993          	addi	s3,s3,1980 # 5948 <statistics+0xbe>
    argv[0] = (char*)0xffffffff;
...
00000000000011b8 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121a:	f5278793          	addi	a5,a5,-174 # 7168 <statistics+0x18de>
  ...
  if(pid == 0){
    ...
    1250:	ecc78793          	addi	a5,a5,-308 # 8118 <big.0>
    1254:	00008697          	auipc	a3,0x8
    1258:	ec468693          	addi	a3,a3,-316 # 9118 <__global_pointer$+0x920>
      big[i] = 'x';
    ...
    126e:	ea078723          	sb	zero,-338(a5) # 9118 <__global_pointer$+0x920>
    char *args2[] = { big, big, big, 0 };
    1272:	00007797          	auipc	a5,0x7
    1276:	94678793          	addi	a5,a5,-1722 # 7bb8 <statistics+0x232e>
    ...
    129a:	6b250513          	addi	a0,a0,1714 # 5948 <statistics+0xbe>
    ...
    12b2:	e9a50513          	addi	a0,a0,-358 # 6148 <statistics+0x8be>
    12b6:	00004097          	auipc	ra,0x4
    12ba:	436080e7          	jalr	1078(ra) # 56ec <printf>
      exit(1);
    12be:	4505                	li	a0,1
    ...
    12d2:	df250513          	addi	a0,a0,-526 # 60c0 <statistics+0x836>
    12d6:	00004097          	auipc	ra,0x4
    12da:	416080e7          	jalr	1046(ra) # 56ec <printf>
    exit(1);
    12de:	4505                	li	a0,1
    ...
    12f2:	df250513          	addi	a0,a0,-526 # 60e0 <statistics+0x856>
    12f6:	00004097          	auipc	ra,0x4
    12fa:	3f6080e7          	jalr	1014(ra) # 56ec <printf>
    exit(1);
    12fe:	4505                	li	a0,1
    ...
    1314:	df050513          	addi	a0,a0,-528 # 6100 <statistics+0x876>
    1318:	00004097          	auipc	ra,0x4
    131c:	3d4080e7          	jalr	980(ra) # 56ec <printf>
    exit(1);
    1320:	4505                	li	a0,1
    ...
    1334:	df850513          	addi	a0,a0,-520 # 6128 <statistics+0x89e>
    1338:	00004097          	auipc	ra,0x4
    133c:	3b4080e7          	jalr	948(ra) # 56ec <printf>
    exit(1);
    1340:	4505                	li	a0,1
    ...
    134e:	24650513          	addi	a0,a0,582 # 6590 <statistics+0xd06>
    1352:	00004097          	auipc	ra,0x4
    1356:	39a080e7          	jalr	922(ra) # 56ec <printf>
    exit(1);
    135a:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1398:	ddc50513          	addi	a0,a0,-548 # 6170 <statistics+0x8e6>
    139c:	00004097          	auipc	ra,0x4
    13a0:	350080e7          	jalr	848(ra) # 56ec <printf>
    exit(1);
    13a4:	4505                	li	a0,1
...
00000000000013ae <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13ca:	5da50513          	addi	a0,a0,1498 # 59a0 <statistics+0x116>
  ...
  if(pid == 0){
    ...
    13f4:	5b0a0a13          	addi	s4,s4,1456 # 59a0 <statistics+0x116>
      int n = write(fd, "1234567890", 10);
    13f8:	00005a97          	auipc	s5,0x5
    13fc:	dd8a8a93          	addi	s5,s5,-552 # 61d0 <statistics+0x946>
      int fd = open("truncfile", O_WRONLY);
    1400:	4585                	li	a1,1
    1402:	8552                	mv	a0,s4
    ...
    146c:	d3850513          	addi	a0,a0,-712 # 61a0 <statistics+0x916>
    1470:	00004097          	auipc	ra,0x4
    1474:	27c080e7          	jalr	636(ra) # 56ec <printf>
    exit(1);
    1478:	4505                	li	a0,1
    ...
    1488:	d3450513          	addi	a0,a0,-716 # 61b8 <statistics+0x92e>
    148c:	00004097          	auipc	ra,0x4
    1490:	260080e7          	jalr	608(ra) # 56ec <printf>
        exit(1);
    1494:	4505                	li	a0,1
    ...
    14a6:	d3e50513          	addi	a0,a0,-706 # 61e0 <statistics+0x956>
    14aa:	00004097          	auipc	ra,0x4
    14ae:	242080e7          	jalr	578(ra) # 56ec <printf>
        exit(1);
    14b2:	4505                	li	a0,1
    ...
    14c4:	4e0a0a13          	addi	s4,s4,1248 # 59a0 <statistics+0x116>
    int n = write(fd, "xxx", 3);
    14c8:	00005a97          	auipc	s5,0x5
    14cc:	d38a8a93          	addi	s5,s5,-712 # 6200 <statistics+0x976>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1516:	48e50513          	addi	a0,a0,1166 # 59a0 <statistics+0x116>
  ...
  exit(xstatus);
    ...
    1534:	c8850513          	addi	a0,a0,-888 # 61b8 <statistics+0x92e>
    1538:	00004097          	auipc	ra,0x4
    153c:	1b4080e7          	jalr	436(ra) # 56ec <printf>
      exit(1);
    1540:	4505                	li	a0,1
    ...
    1552:	cba50513          	addi	a0,a0,-838 # 6208 <statistics+0x97e>
    1556:	00004097          	auipc	ra,0x4
    155a:	196080e7          	jalr	406(ra) # 56ec <printf>
      exit(1);
    155e:	4505                	li	a0,1
...
0000000000001568 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    157a:	3d278793          	addi	a5,a5,978 # 5948 <statistics+0xbe>
    157e:	fcf43023          	sd	a5,-64(s0)
    1582:	00005797          	auipc	a5,0x5
    1586:	ca678793          	addi	a5,a5,-858 # 6228 <statistics+0x99e>
    158a:	fcf43423          	sd	a5,-56(s0)
    158e:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1592:	00005517          	auipc	a0,0x5
    1596:	c9e50513          	addi	a0,a0,-866 # 6230 <statistics+0x9a6>
  ...
  if(pid == 0) {
    ...
    15c4:	c7050513          	addi	a0,a0,-912 # 6230 <statistics+0x9a6>
    ...
    15e0:	c7450513          	addi	a0,a0,-908 # 6250 <statistics+0x9c6>
    15e4:	00004097          	auipc	ra,0x4
    15e8:	108080e7          	jalr	264(ra) # 56ec <printf>
      exit(1);
    15ec:	4505                	li	a0,1
    ...
    15fc:	ba850513          	addi	a0,a0,-1112 # 61a0 <statistics+0x916>
    1600:	00004097          	auipc	ra,0x4
    1604:	0ec080e7          	jalr	236(ra) # 56ec <printf>
     exit(1);
    1608:	4505                	li	a0,1
    ...
    1618:	c2450513          	addi	a0,a0,-988 # 6238 <statistics+0x9ae>
    161c:	00004097          	auipc	ra,0x4
    1620:	0d0080e7          	jalr	208(ra) # 56ec <printf>
      exit(1);
    1624:	4505                	li	a0,1
    ...
    1636:	31650513          	addi	a0,a0,790 # 5948 <statistics+0xbe>
  ...
  if(xstatus != 0)
    ...
    166a:	bfa50513          	addi	a0,a0,-1030 # 6260 <statistics+0x9d6>
    166e:	00004097          	auipc	ra,0x4
    1672:	07e080e7          	jalr	126(ra) # 56ec <printf>
      exit(1);
    1676:	4505                	li	a0,1
    ...
    1686:	bf650513          	addi	a0,a0,-1034 # 6278 <statistics+0x9ee>
    168a:	00004097          	auipc	ra,0x4
    168e:	062080e7          	jalr	98(ra) # 56ec <printf>
    1692:	b7d1                	j	1656 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    1694:	4581                	li	a1,0
    1696:	00005517          	auipc	a0,0x5
    169a:	b9a50513          	addi	a0,a0,-1126 # 6230 <statistics+0x9a6>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16c4:	62850513          	addi	a0,a0,1576 # 5ce8 <statistics+0x45e>
    16c8:	00004097          	auipc	ra,0x4
    16cc:	024080e7          	jalr	36(ra) # 56ec <printf>
    exit(1);
    16d0:	4505                	li	a0,1
    ...
    16e0:	adc50513          	addi	a0,a0,-1316 # 61b8 <statistics+0x92e>
    16e4:	00004097          	auipc	ra,0x4
    16e8:	008080e7          	jalr	8(ra) # 56ec <printf>
    exit(1);
    16ec:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16fa:	b3a50513          	addi	a0,a0,-1222 # 6230 <statistics+0x9a6>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1724:	b7050513          	addi	a0,a0,-1168 # 6290 <statistics+0xa06>
    1728:	00004097          	auipc	ra,0x4
    172c:	fc4080e7          	jalr	-60(ra) # 56ec <printf>
    exit(1);
    1730:	4505                	li	a0,1
...
0000000000001744 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1790:	0a4a8a93          	addi	s5,s5,164 # b830 <buf>
      if(cc > sizeof(buf))
    ...
    17ae:	08670713          	addi	a4,a4,134 # b830 <buf>
    ...
    17e4:	ac850513          	addi	a0,a0,-1336 # 62a8 <statistics+0xa1e>
    17e8:	00004097          	auipc	ra,0x4
    17ec:	f04080e7          	jalr	-252(ra) # 56ec <printf>
    exit(1);
    17f0:	4505                	li	a0,1
    ...
    180a:	02ab0b13          	addi	s6,s6,42 # b830 <buf>
    ...
    181e:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x7f>
{
    ...
    186a:	a5a50513          	addi	a0,a0,-1446 # 62c0 <statistics+0xa36>
    186e:	00004097          	auipc	ra,0x4
    1872:	e7e080e7          	jalr	-386(ra) # 56ec <printf>
        exit(1);
    1876:	4505                	li	a0,1
    ...
    1886:	a5650513          	addi	a0,a0,-1450 # 62d8 <statistics+0xa4e>
    188a:	00004097          	auipc	ra,0x4
    188e:	e62080e7          	jalr	-414(ra) # 56ec <printf>
}
    ...
    18b8:	a3c50513          	addi	a0,a0,-1476 # 62f0 <statistics+0xa66>
    18bc:	00004097          	auipc	ra,0x4
    18c0:	e30080e7          	jalr	-464(ra) # 56ec <printf>
      exit(1);
    18c4:	4505                	li	a0,1
    ...
    18f8:	a1c50513          	addi	a0,a0,-1508 # 6310 <statistics+0xa86>
    18fc:	00004097          	auipc	ra,0x4
    1900:	df0080e7          	jalr	-528(ra) # 56ec <printf>
    exit(1);
    1904:	4505                	li	a0,1
...
000000000000190e <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    196a:	83a50513          	addi	a0,a0,-1990 # 61a0 <statistics+0x916>
    196e:	00004097          	auipc	ra,0x4
    1972:	d7e080e7          	jalr	-642(ra) # 56ec <printf>
      exit(1);
    1976:	4505                	li	a0,1
    ...
    1986:	9a650513          	addi	a0,a0,-1626 # 6328 <statistics+0xa9e>
    198a:	00004097          	auipc	ra,0x4
    198e:	d62080e7          	jalr	-670(ra) # 56ec <printf>
        exit(1);
    1992:	4505                	li	a0,1
    ...
    19a2:	9a250513          	addi	a0,a0,-1630 # 6340 <statistics+0xab6>
    19a6:	00004097          	auipc	ra,0x4
    19aa:	d46080e7          	jalr	-698(ra) # 56ec <printf>
        exit(1);
    19ae:	4505                	li	a0,1
...
00000000000019c2 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a1a:	78a50513          	addi	a0,a0,1930 # 61a0 <statistics+0x916>
    1a1e:	00004097          	auipc	ra,0x4
    1a22:	cce080e7          	jalr	-818(ra) # 56ec <printf>
      exit(1);
    1a26:	4505                	li	a0,1
    ...
    1a3e:	76650513          	addi	a0,a0,1894 # 61a0 <statistics+0x916>
    1a42:	00004097          	auipc	ra,0x4
    1a46:	caa080e7          	jalr	-854(ra) # 56ec <printf>
        exit(1);
    1a4a:	4505                	li	a0,1
...
0000000000001a5c <forkfork>:
{
    ...
    1ab8:	8ac50513          	addi	a0,a0,-1876 # 6360 <statistics+0xad6>
    1abc:	00004097          	auipc	ra,0x4
    1ac0:	c30080e7          	jalr	-976(ra) # 56ec <printf>
      exit(1);
    1ac4:	4505                	li	a0,1
    ...
    1aca:	8a4080e7          	jalr	-1884(ra) # 536a <exit>
{
    ...
    1b10:	86450513          	addi	a0,a0,-1948 # 6370 <statistics+0xae6>
    1b14:	00004097          	auipc	ra,0x4
    1b18:	bd8080e7          	jalr	-1064(ra) # 56ec <printf>
      exit(1);
    1b1c:	4505                	li	a0,1
...
0000000000001b26 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5e:	a3650513          	addi	a0,a0,-1482 # 6590 <statistics+0xd06>
    1b62:	00004097          	auipc	ra,0x4
    1b66:	b8a080e7          	jalr	-1142(ra) # 56ec <printf>
      exit(1);
    1b6a:	4505                	li	a0,1
...
0000000000001b8e <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bfc:	99850513          	addi	a0,a0,-1640 # 6590 <statistics+0xd06>
    1c00:	00004097          	auipc	ra,0x4
    1c04:	aec080e7          	jalr	-1300(ra) # 56ec <printf>
      exit(1);
    1c08:	4505                	li	a0,1
    ...
    1c28:	61450513          	addi	a0,a0,1556 # 6238 <statistics+0x9ae>
    1c2c:	00004097          	auipc	ra,0x4
    1c30:	ac0080e7          	jalr	-1344(ra) # 56ec <printf>
          exit(1);
    1c34:	4505                	li	a0,1
    ...
    1c9a:	6fa50513          	addi	a0,a0,1786 # 6390 <statistics+0xb06>
    1c9e:	00004097          	auipc	ra,0x4
    1ca2:	a4e080e7          	jalr	-1458(ra) # 56ec <printf>
            exit(1);
    1ca6:	4505                	li	a0,1
    ...
    1cce:	6de50513          	addi	a0,a0,1758 # 63a8 <statistics+0xb1e>
    1cd2:	00004097          	auipc	ra,0x4
    1cd6:	a1a080e7          	jalr	-1510(ra) # 56ec <printf>
        exit(1);
    1cda:	4505                	li	a0,1
    ...
    1d34:	6a050513          	addi	a0,a0,1696 # 63d0 <statistics+0xb46>
    1d38:	00004097          	auipc	ra,0x4
    1d3c:	9b4080e7          	jalr	-1612(ra) # 56ec <printf>
        exit(1);
    1d40:	4505                	li	a0,1
...
0000000000001db4 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd4:	be850513          	addi	a0,a0,-1048 # 59b8 <statistics+0x12e>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1dfe:	e6d9899b          	addiw	s3,s3,-403 # 41c64e6d <__BSS_END__+0x41c5662d>
    ...
    1e10:	baca8a93          	addi	s5,s5,-1108 # 59b8 <statistics+0x12e>
      link("cat", "x");
    1e14:	00004b97          	auipc	s7,0x4
    1e18:	5e4b8b93          	addi	s7,s7,1508 # 63f8 <statistics+0xb6e>
    1e1c:	a825                	j	1e54 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e1e:	85a6                	mv	a1,s1
    1e20:	00004517          	auipc	a0,0x4
    1e24:	38050513          	addi	a0,a0,896 # 61a0 <statistics+0x916>
    1e28:	00004097          	auipc	ra,0x4
    1e2c:	8c4080e7          	jalr	-1852(ra) # 56ec <printf>
    exit(1);
    1e30:	4505                	li	a0,1
...
0000000000001eb6 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1ee6:	53650513          	addi	a0,a0,1334 # 6418 <statistics+0xb8e>
    1eea:	00004097          	auipc	ra,0x4
    1eee:	802080e7          	jalr	-2046(ra) # 56ec <printf>
    exit(1);
    1ef2:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    1f48:	4bc50513          	addi	a0,a0,1212 # 6400 <statistics+0xb76>
    1f4c:	00003097          	auipc	ra,0x3
    1f50:	7a0080e7          	jalr	1952(ra) # 56ec <printf>
    exit(1);
    1f54:	4505                	li	a0,1
    ...
    1f64:	4e050513          	addi	a0,a0,1248 # 6440 <statistics+0xbb6>
    1f68:	00003097          	auipc	ra,0x3
    1f6c:	784080e7          	jalr	1924(ra) # 56ec <printf>
      exit(1);
    1f70:	4505                	li	a0,1
    ...
    1f80:	4dc50513          	addi	a0,a0,1244 # 6458 <statistics+0xbce>
    1f84:	00003097          	auipc	ra,0x3
    1f88:	768080e7          	jalr	1896(ra) # 56ec <printf>
    exit(1);
    1f8c:	4505                	li	a0,1
...
0000000000001f96 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1fb2:	35098993          	addi	s3,s3,848 # c350 <buf+0xb20>
    1fb6:	1003d937          	lui	s2,0x1003d
    1fba:	090e                	slli	s2,s2,0x3
    1fbc:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002ec40>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2000:	1a450513          	addi	a0,a0,420 # 61a0 <statistics+0x916>
    2004:	00003097          	auipc	ra,0x3
    2008:	6e8080e7          	jalr	1768(ra) # 56ec <printf>
      exit(1);
    200c:	4505                	li	a0,1
    ...
    2020:	45450513          	addi	a0,a0,1108 # 6470 <statistics+0xbe6>
    2024:	00003097          	auipc	ra,0x3
    2028:	6c8080e7          	jalr	1736(ra) # 56ec <printf>
      exit(1);
    202c:	4505                	li	a0,1
...
0000000000002040 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2050:	44450513          	addi	a0,a0,1092 # 6490 <statistics+0xc06>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2082:	41250513          	addi	a0,a0,1042 # 6490 <statistics+0xc06>
  ...
  close(fd);
    ...
    20a8:	f7478793          	addi	a5,a5,-140 # 8018 <args.1>
    20ac:	00006697          	auipc	a3,0x6
    20b0:	06468693          	addi	a3,a3,100 # 8110 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    20b4:	00004717          	auipc	a4,0x4
    20b8:	3ec70713          	addi	a4,a4,1004 # 64a0 <statistics+0xc16>
    ...
    210c:	47850513          	addi	a0,a0,1144 # 6580 <statistics+0xcf6>
    2110:	00003097          	auipc	ra,0x3
    2114:	5dc080e7          	jalr	1500(ra) # 56ec <printf>
    exit(1);
    2118:	4505                	li	a0,1
    ...
    2130:	47450513          	addi	a0,a0,1140 # 65a0 <statistics+0xd16>
    2134:	00003097          	auipc	ra,0x3
    2138:	5b8080e7          	jalr	1464(ra) # 56ec <printf>
    exit(1);
    213c:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2184:	0007c583          	lbu	a1,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff07c0>
    2188:	00004517          	auipc	a0,0x4
    218c:	43850513          	addi	a0,a0,1080 # 65c0 <statistics+0xd36>
    2190:	00003097          	auipc	ra,0x3
    2194:	55c080e7          	jalr	1372(ra) # 56ec <printf>
    exit(1);
    2198:	4505                	li	a0,1
    ...
    21a8:	ffc50513          	addi	a0,a0,-4 # 61a0 <statistics+0x916>
    21ac:	00003097          	auipc	ra,0x3
    21b0:	540080e7          	jalr	1344(ra) # 56ec <printf>
    exit(1);
    21b4:	4505                	li	a0,1
...
00000000000021c8 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2242:	f2a78793          	addi	a5,a5,-214 # 7168 <statistics+0x18de>
  ...
  if(ret != -1){
    ...
    2284:	36850513          	addi	a0,a0,872 # 65e8 <statistics+0xd5e>
    2288:	00003097          	auipc	ra,0x3
    228c:	464080e7          	jalr	1124(ra) # 56ec <printf>
    exit(1);
    2290:	4505                	li	a0,1
    ...
    22a2:	e2250513          	addi	a0,a0,-478 # 60c0 <statistics+0x836>
    22a6:	00003097          	auipc	ra,0x3
    22aa:	446080e7          	jalr	1094(ra) # 56ec <printf>
    exit(1);
    22ae:	4505                	li	a0,1
    ...
    22c0:	e2450513          	addi	a0,a0,-476 # 60e0 <statistics+0x856>
    22c4:	00003097          	auipc	ra,0x3
    22c8:	428080e7          	jalr	1064(ra) # 56ec <printf>
    exit(1);
    22cc:	4505                	li	a0,1
    ...
    22e0:	e2450513          	addi	a0,a0,-476 # 6100 <statistics+0x876>
    22e4:	00003097          	auipc	ra,0x3
    22e8:	408080e7          	jalr	1032(ra) # 56ec <printf>
    exit(1);
    22ec:	4505                	li	a0,1
    ...
    22fe:	e2e50513          	addi	a0,a0,-466 # 6128 <statistics+0x89e>
    2302:	00003097          	auipc	ra,0x3
    2306:	3ea080e7          	jalr	1002(ra) # 56ec <printf>
    exit(1);
    230a:	4505                	li	a0,1
...
0000000000002314 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2350:	6705                	lui	a4,0x1
      *b = 99;
    2352:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff17c0>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    236a:	28a50513          	addi	a0,a0,650 # 65f0 <statistics+0xd66>
    236e:	00003097          	auipc	ra,0x3
    2372:	37e080e7          	jalr	894(ra) # 56ec <printf>
    exit(1);
    2376:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    23bc:	25850513          	addi	a0,a0,600 # 6610 <statistics+0xd86>
    23c0:	00003097          	auipc	ra,0x3
    23c4:	32c080e7          	jalr	812(ra) # 56ec <printf>
    exit(1);
    23c8:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2420:	25450513          	addi	a0,a0,596 # 6670 <statistics+0xde6>
    2424:	00003097          	auipc	ra,0x3
    2428:	2c8080e7          	jalr	712(ra) # 56ec <printf>
    exit(1);
    242c:	4505                	li	a0,1
    ...
    2440:	1f450513          	addi	a0,a0,500 # 6630 <statistics+0xda6>
    2444:	00003097          	auipc	ra,0x3
    2448:	2a8080e7          	jalr	680(ra) # 56ec <printf>
      exit(1);
    244c:	4505                	li	a0,1
    ...
    245c:	1f850513          	addi	a0,a0,504 # 6650 <statistics+0xdc6>
    2460:	00003097          	auipc	ra,0x3
    2464:	28c080e7          	jalr	652(ra) # 56ec <printf>
    exit(1);
    2468:	4505                	li	a0,1
...
0000000000002498 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    24fa:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f17bf>
  a = sbrk(0);
    24fe:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    255e:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f17bf>
  ...
  if(c != a){
    ...
    25a6:	0ee50513          	addi	a0,a0,238 # 6690 <statistics+0xe06>
    25aa:	00003097          	auipc	ra,0x3
    25ae:	142080e7          	jalr	322(ra) # 56ec <printf>
    exit(1);
    25b2:	4505                	li	a0,1
    ...
    25c2:	11a50513          	addi	a0,a0,282 # 66d8 <statistics+0xe4e>
    25c6:	00003097          	auipc	ra,0x3
    25ca:	126080e7          	jalr	294(ra) # 56ec <printf>
    exit(1);
    25ce:	4505                	li	a0,1
    ...
    25e0:	11c50513          	addi	a0,a0,284 # 66f8 <statistics+0xe6e>
    25e4:	00003097          	auipc	ra,0x3
    25e8:	108080e7          	jalr	264(ra) # 56ec <printf>
    exit(1);
    25ec:	4505                	li	a0,1
    ...
    25fe:	13e50513          	addi	a0,a0,318 # 6738 <statistics+0xeae>
    2602:	00003097          	auipc	ra,0x3
    2606:	0ea080e7          	jalr	234(ra) # 56ec <printf>
    exit(1);
    260a:	4505                	li	a0,1
    ...
    261a:	15250513          	addi	a0,a0,338 # 6768 <statistics+0xede>
    261e:	00003097          	auipc	ra,0x3
    2622:	0ce080e7          	jalr	206(ra) # 56ec <printf>
    exit(1);
    2626:	4505                	li	a0,1
    ...
    2638:	16c50513          	addi	a0,a0,364 # 67a0 <statistics+0xf16>
    263c:	00003097          	auipc	ra,0x3
    2640:	0b0080e7          	jalr	176(ra) # 56ec <printf>
    exit(1);
    2644:	4505                	li	a0,1
...
000000000000264e <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2672:	15a50513          	addi	a0,a0,346 # 67c8 <statistics+0xf3e>
    2676:	00003097          	auipc	ra,0x3
    267a:	d34080e7          	jalr	-716(ra) # 53aa <open>
    267e:	84aa                	mv	s1,a0
  unlink("sbrk");
    2680:	00004517          	auipc	a0,0x4
    2684:	14850513          	addi	a0,a0,328 # 67c8 <statistics+0xf3e>
  ...
  if(pipe((int *) a) != 0){
    ...
    26d8:	0fc50513          	addi	a0,a0,252 # 67d0 <statistics+0xf46>
    26dc:	00003097          	auipc	ra,0x3
    26e0:	010080e7          	jalr	16(ra) # 56ec <printf>
    exit(1);
    26e4:	4505                	li	a0,1
    ...
    26f4:	0f850513          	addi	a0,a0,248 # 67e8 <statistics+0xf5e>
    26f8:	00003097          	auipc	ra,0x3
    26fc:	ff4080e7          	jalr	-12(ra) # 56ec <printf>
    exit(1);
    2700:	4505                	li	a0,1
    ...
    2710:	b9c50513          	addi	a0,a0,-1124 # 62a8 <statistics+0xa1e>
    2714:	00003097          	auipc	ra,0x3
    2718:	fd8080e7          	jalr	-40(ra) # 56ec <printf>
    exit(1);
    271c:	4505                	li	a0,1
...
0000000000002726 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    273a:	0ca50513          	addi	a0,a0,202 # 6800 <statistics+0xf76>
  ...
  close(fd);
    ...
    2782:	a3a50513          	addi	a0,a0,-1478 # 61b8 <statistics+0x92e>
    2786:	00003097          	auipc	ra,0x3
    278a:	f66080e7          	jalr	-154(ra) # 56ec <printf>
    exit(1);
    278e:	4505                	li	a0,1
...
0000000000002798 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    27d0:	dc450513          	addi	a0,a0,-572 # 6590 <statistics+0xd06>
    27d4:	00003097          	auipc	ra,0x3
    27d8:	f18080e7          	jalr	-232(ra) # 56ec <printf>
    exit(1);
    27dc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2826:	d6e50513          	addi	a0,a0,-658 # 6590 <statistics+0xd06>
    282a:	00003097          	auipc	ra,0x3
    282e:	ec2080e7          	jalr	-318(ra) # 56ec <printf>
    exit(1);
    2832:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    285e:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x16e0>
    ...
    2886:	d0e50513          	addi	a0,a0,-754 # 6590 <statistics+0xd06>
    288a:	00003097          	auipc	ra,0x3
    288e:	e62080e7          	jalr	-414(ra) # 56ec <printf>
    exit(1);
    2892:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    28f2:	ca250513          	addi	a0,a0,-862 # 6590 <statistics+0xd06>
    28f6:	00003097          	auipc	ra,0x3
    28fa:	df6080e7          	jalr	-522(ra) # 56ec <printf>
      exit(1);
    28fe:	4505                	li	a0,1
    ...
    2946:	00650513          	addi	a0,a0,6 # 5948 <statistics+0xbe>
    294a:	faa43c23          	sd	a0,-72(s0)
    294e:	00003797          	auipc	a5,0x3
    2952:	06a78793          	addi	a5,a5,106 # 59b8 <statistics+0x12e>
...
0000000000002974 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2984:	05850513          	addi	a0,a0,88 # 69d8 <statistics+0x114e>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2996:	e9e50513          	addi	a0,a0,-354 # 6830 <statistics+0xfa6>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29ac:	ee050513          	addi	a0,a0,-288 # 6888 <statistics+0xffe>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    29ca:	f3a50513          	addi	a0,a0,-198 # 6900 <statistics+0x1076>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    29e6:	f8e50513          	addi	a0,a0,-114 # 6970 <statistics+0x10e6>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    29f8:	fd450513          	addi	a0,a0,-44 # 69c8 <statistics+0x113e>
  ...
  unlink("12345678901234");
    ...
    2a76:	d9650513          	addi	a0,a0,-618 # 6808 <statistics+0xf7e>
    2a7a:	00003097          	auipc	ra,0x3
    2a7e:	c72080e7          	jalr	-910(ra) # 56ec <printf>
    exit(1);
    2a82:	4505                	li	a0,1
    ...
    2a92:	dc250513          	addi	a0,a0,-574 # 6850 <statistics+0xfc6>
    2a96:	00003097          	auipc	ra,0x3
    2a9a:	c56080e7          	jalr	-938(ra) # 56ec <printf>
    exit(1);
    2a9e:	4505                	li	a0,1
    ...
    2aae:	e0e50513          	addi	a0,a0,-498 # 68b8 <statistics+0x102e>
    2ab2:	00003097          	auipc	ra,0x3
    2ab6:	c3a080e7          	jalr	-966(ra) # 56ec <printf>
    exit(1);
    2aba:	4505                	li	a0,1
    ...
    2aca:	e6a50513          	addi	a0,a0,-406 # 6930 <statistics+0x10a6>
    2ace:	00003097          	auipc	ra,0x3
    2ad2:	c1e080e7          	jalr	-994(ra) # 56ec <printf>
    exit(1);
    2ad6:	4505                	li	a0,1
    ...
    2ae6:	eae50513          	addi	a0,a0,-338 # 6990 <statistics+0x1106>
    2aea:	00003097          	auipc	ra,0x3
    2aee:	c02080e7          	jalr	-1022(ra) # 56ec <printf>
    exit(1);
    2af2:	4505                	li	a0,1
    ...
    2b02:	eea50513          	addi	a0,a0,-278 # 69e8 <statistics+0x115e>
    2b06:	00003097          	auipc	ra,0x3
    2b0a:	be6080e7          	jalr	-1050(ra) # 56ec <printf>
    exit(1);
    2b0e:	4505                	li	a0,1
...
0000000000002b18 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2b28:	efc50513          	addi	a0,a0,-260 # 6a20 <statistics+0x1196>
  ...
  if(chdir("iputdir") < 0){
    ...
    2b3c:	ee850513          	addi	a0,a0,-280 # 6a20 <statistics+0x1196>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2b50:	f1450513          	addi	a0,a0,-236 # 6a60 <statistics+0x11d6>
  ...
  if(chdir("/") < 0){
    ...
    2b64:	f3050513          	addi	a0,a0,-208 # 6a90 <statistics+0x1206>
    ...
    2b84:	ea850513          	addi	a0,a0,-344 # 6a28 <statistics+0x119e>
    2b88:	00003097          	auipc	ra,0x3
    2b8c:	b64080e7          	jalr	-1180(ra) # 56ec <printf>
    exit(1);
    2b90:	4505                	li	a0,1
    ...
    2ba0:	ea450513          	addi	a0,a0,-348 # 6a40 <statistics+0x11b6>
    2ba4:	00003097          	auipc	ra,0x3
    2ba8:	b48080e7          	jalr	-1208(ra) # 56ec <printf>
    exit(1);
    2bac:	4505                	li	a0,1
    ...
    2bbc:	eb850513          	addi	a0,a0,-328 # 6a70 <statistics+0x11e6>
    2bc0:	00003097          	auipc	ra,0x3
    2bc4:	b2c080e7          	jalr	-1236(ra) # 56ec <printf>
    exit(1);
    2bc8:	4505                	li	a0,1
    ...
    2bd8:	ec450513          	addi	a0,a0,-316 # 6a98 <statistics+0x120e>
    2bdc:	00003097          	auipc	ra,0x3
    2be0:	b10080e7          	jalr	-1264(ra) # 56ec <printf>
    exit(1);
    2be4:	4505                	li	a0,1
...
0000000000002bee <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2c0c:	e1850513          	addi	a0,a0,-488 # 6a20 <statistics+0x1196>
    ...
    2c20:	e0450513          	addi	a0,a0,-508 # 6a20 <statistics+0x1196>
    ...
    2c34:	e3050513          	addi	a0,a0,-464 # 6a60 <statistics+0x11d6>
    ...
    2c54:	55050513          	addi	a0,a0,1360 # 61a0 <statistics+0x916>
    2c58:	00003097          	auipc	ra,0x3
    2c5c:	a94080e7          	jalr	-1388(ra) # 56ec <printf>
    exit(1);
    2c60:	4505                	li	a0,1
    ...
    2c70:	dbc50513          	addi	a0,a0,-580 # 6a28 <statistics+0x119e>
    2c74:	00003097          	auipc	ra,0x3
    2c78:	a78080e7          	jalr	-1416(ra) # 56ec <printf>
      exit(1);
    2c7c:	4505                	li	a0,1
    ...
    2c8c:	e2850513          	addi	a0,a0,-472 # 6ab0 <statistics+0x1226>
    2c90:	00003097          	auipc	ra,0x3
    2c94:	a5c080e7          	jalr	-1444(ra) # 56ec <printf>
      exit(1);
    2c98:	4505                	li	a0,1
    ...
    2ca8:	dcc50513          	addi	a0,a0,-564 # 6a70 <statistics+0x11e6>
    2cac:	00003097          	auipc	ra,0x3
    2cb0:	a40080e7          	jalr	-1472(ra) # 56ec <printf>
      exit(1);
    2cb4:	4505                	li	a0,1
...
0000000000002cd6 <subdir>:
{
  ...
  unlink("ff");
    ...
    2ce8:	f1450513          	addi	a0,a0,-236 # 6bf8 <statistics+0x136e>
    2cec:	00002097          	auipc	ra,0x2
    2cf0:	6ce080e7          	jalr	1742(ra) # 53ba <unlink>
  if(mkdir("dd") != 0){
    2cf4:	00004517          	auipc	a0,0x4
    2cf8:	dd450513          	addi	a0,a0,-556 # 6ac8 <statistics+0x123e>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d10:	ddc50513          	addi	a0,a0,-548 # 6ae8 <statistics+0x125e>
  ...
  write(fd, "ff", 2);
    ...
    2d28:	ed458593          	addi	a1,a1,-300 # 6bf8 <statistics+0x136e>
  ...
  if(unlink("dd") >= 0){
    ...
    2d42:	d8a50513          	addi	a0,a0,-630 # 6ac8 <statistics+0x123e>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2d56:	dee50513          	addi	a0,a0,-530 # 6b40 <statistics+0x12b6>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d6e:	dfe50513          	addi	a0,a0,-514 # 6b68 <statistics+0x12de>
  ...
  write(fd, "FF", 2);
    ...
    2d86:	e1658593          	addi	a1,a1,-490 # 6b98 <statistics+0x130e>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da2:	e0250513          	addi	a0,a0,-510 # 6ba0 <statistics+0x1316>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2dba:	a7a58593          	addi	a1,a1,-1414 # b830 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2dd0:	a6474703          	lbu	a4,-1436(a4) # b830 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2dea:	e0a58593          	addi	a1,a1,-502 # 6bf0 <statistics+0x1366>
    2dee:	00004517          	auipc	a0,0x4
    2df2:	d7a50513          	addi	a0,a0,-646 # 6b68 <statistics+0x12de>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2e06:	d6650513          	addi	a0,a0,-666 # 6b68 <statistics+0x12de>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e1c:	d5050513          	addi	a0,a0,-688 # 6b68 <statistics+0x12de>
  ...
  if(chdir("dd") != 0){
    ...
    2e30:	c9c50513          	addi	a0,a0,-868 # 6ac8 <statistics+0x123e>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2e44:	e4850513          	addi	a0,a0,-440 # 6c88 <statistics+0x13fe>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2e58:	e6450513          	addi	a0,a0,-412 # 6cb8 <statistics+0x142e>
  ...
  if(chdir("./..") != 0){
    ...
    2e6c:	e8050513          	addi	a0,a0,-384 # 6ce8 <statistics+0x145e>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2e82:	d7250513          	addi	a0,a0,-654 # 6bf0 <statistics+0x1366>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2e9a:	99a58593          	addi	a1,a1,-1638 # b830 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2ebc:	cb050513          	addi	a0,a0,-848 # 6b68 <statistics+0x12de>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2ed4:	ea850513          	addi	a0,a0,-344 # 6d78 <statistics+0x14ee>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2eec:	ec050513          	addi	a0,a0,-320 # 6da8 <statistics+0x151e>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2f04:	bc850513          	addi	a0,a0,-1080 # 6ac8 <statistics+0x123e>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2f1a:	bb250513          	addi	a0,a0,-1102 # 6ac8 <statistics+0x123e>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2f30:	b9c50513          	addi	a0,a0,-1124 # 6ac8 <statistics+0x123e>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2f44:	ef858593          	addi	a1,a1,-264 # 6e38 <statistics+0x15ae>
    2f48:	00004517          	auipc	a0,0x4
    2f4c:	e3050513          	addi	a0,a0,-464 # 6d78 <statistics+0x14ee>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2f60:	edc58593          	addi	a1,a1,-292 # 6e38 <statistics+0x15ae>
    2f64:	00004517          	auipc	a0,0x4
    2f68:	e4450513          	addi	a0,a0,-444 # 6da8 <statistics+0x151e>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2f7c:	c7858593          	addi	a1,a1,-904 # 6bf0 <statistics+0x1366>
    2f80:	00004517          	auipc	a0,0x4
    2f84:	b6850513          	addi	a0,a0,-1176 # 6ae8 <statistics+0x125e>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2f98:	de450513          	addi	a0,a0,-540 # 6d78 <statistics+0x14ee>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2fac:	e0050513          	addi	a0,a0,-512 # 6da8 <statistics+0x151e>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2fc0:	c3450513          	addi	a0,a0,-972 # 6bf0 <statistics+0x1366>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2fd4:	dd850513          	addi	a0,a0,-552 # 6da8 <statistics+0x151e>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2fe8:	d9450513          	addi	a0,a0,-620 # 6d78 <statistics+0x14ee>
  ...
  if(chdir("dd/ff") == 0){
    ...
    2ffc:	af050513          	addi	a0,a0,-1296 # 6ae8 <statistics+0x125e>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3010:	f7c50513          	addi	a0,a0,-132 # 6f88 <statistics+0x16fe>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3024:	bd050513          	addi	a0,a0,-1072 # 6bf0 <statistics+0x1366>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3038:	ab450513          	addi	a0,a0,-1356 # 6ae8 <statistics+0x125e>
  ...
  if(unlink("dd") == 0){
    ...
    304c:	a8050513          	addi	a0,a0,-1408 # 6ac8 <statistics+0x123e>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3060:	f9c50513          	addi	a0,a0,-100 # 6ff8 <statistics+0x176e>
  ...
  if(unlink("dd") < 0){
    ...
    3074:	a5850513          	addi	a0,a0,-1448 # 6ac8 <statistics+0x123e>
    ...
    3096:	a3e50513          	addi	a0,a0,-1474 # 6ad0 <statistics+0x1246>
    309a:	00002097          	auipc	ra,0x2
    309e:	652080e7          	jalr	1618(ra) # 56ec <printf>
    exit(1);
    30a2:	4505                	li	a0,1
    ...
    30b2:	a4250513          	addi	a0,a0,-1470 # 6af0 <statistics+0x1266>
    30b6:	00002097          	auipc	ra,0x2
    30ba:	636080e7          	jalr	1590(ra) # 56ec <printf>
    exit(1);
    30be:	4505                	li	a0,1
    ...
    30ce:	a4650513          	addi	a0,a0,-1466 # 6b10 <statistics+0x1286>
    30d2:	00002097          	auipc	ra,0x2
    30d6:	61a080e7          	jalr	1562(ra) # 56ec <printf>
    exit(1);
    30da:	4505                	li	a0,1
    ...
    30ea:	a6250513          	addi	a0,a0,-1438 # 6b48 <statistics+0x12be>
    30ee:	00002097          	auipc	ra,0x2
    30f2:	5fe080e7          	jalr	1534(ra) # 56ec <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    ...
    3106:	a7650513          	addi	a0,a0,-1418 # 6b78 <statistics+0x12ee>
    310a:	00002097          	auipc	ra,0x2
    310e:	5e2080e7          	jalr	1506(ra) # 56ec <printf>
    exit(1);
    3112:	4505                	li	a0,1
    ...
    3122:	a9250513          	addi	a0,a0,-1390 # 6bb0 <statistics+0x1326>
    3126:	00002097          	auipc	ra,0x2
    312a:	5c6080e7          	jalr	1478(ra) # 56ec <printf>
    exit(1);
    312e:	4505                	li	a0,1
    ...
    313e:	a9650513          	addi	a0,a0,-1386 # 6bd0 <statistics+0x1346>
    3142:	00002097          	auipc	ra,0x2
    3146:	5aa080e7          	jalr	1450(ra) # 56ec <printf>
    exit(1);
    314a:	4505                	li	a0,1
    ...
    315a:	aaa50513          	addi	a0,a0,-1366 # 6c00 <statistics+0x1376>
    315e:	00002097          	auipc	ra,0x2
    3162:	58e080e7          	jalr	1422(ra) # 56ec <printf>
    exit(1);
    3166:	4505                	li	a0,1
    ...
    3176:	ab650513          	addi	a0,a0,-1354 # 6c28 <statistics+0x139e>
    317a:	00002097          	auipc	ra,0x2
    317e:	572080e7          	jalr	1394(ra) # 56ec <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    3192:	aba50513          	addi	a0,a0,-1350 # 6c48 <statistics+0x13be>
    3196:	00002097          	auipc	ra,0x2
    319a:	556080e7          	jalr	1366(ra) # 56ec <printf>
    exit(1);
    319e:	4505                	li	a0,1
    ...
    31ae:	ac650513          	addi	a0,a0,-1338 # 6c70 <statistics+0x13e6>
    31b2:	00002097          	auipc	ra,0x2
    31b6:	53a080e7          	jalr	1338(ra) # 56ec <printf>
    exit(1);
    31ba:	4505                	li	a0,1
    ...
    31ca:	ad250513          	addi	a0,a0,-1326 # 6c98 <statistics+0x140e>
    31ce:	00002097          	auipc	ra,0x2
    31d2:	51e080e7          	jalr	1310(ra) # 56ec <printf>
    exit(1);
    31d6:	4505                	li	a0,1
    ...
    31e6:	ae650513          	addi	a0,a0,-1306 # 6cc8 <statistics+0x143e>
    31ea:	00002097          	auipc	ra,0x2
    31ee:	502080e7          	jalr	1282(ra) # 56ec <printf>
    exit(1);
    31f2:	4505                	li	a0,1
    ...
    3202:	af250513          	addi	a0,a0,-1294 # 6cf0 <statistics+0x1466>
    3206:	00002097          	auipc	ra,0x2
    320a:	4e6080e7          	jalr	1254(ra) # 56ec <printf>
    exit(1);
    320e:	4505                	li	a0,1
    ...
    321e:	aee50513          	addi	a0,a0,-1298 # 6d08 <statistics+0x147e>
    3222:	00002097          	auipc	ra,0x2
    3226:	4ca080e7          	jalr	1226(ra) # 56ec <printf>
    exit(1);
    322a:	4505                	li	a0,1
    ...
    323a:	af250513          	addi	a0,a0,-1294 # 6d28 <statistics+0x149e>
    323e:	00002097          	auipc	ra,0x2
    3242:	4ae080e7          	jalr	1198(ra) # 56ec <printf>
    exit(1);
    3246:	4505                	li	a0,1
    ...
    3256:	af650513          	addi	a0,a0,-1290 # 6d48 <statistics+0x14be>
    325a:	00002097          	auipc	ra,0x2
    325e:	492080e7          	jalr	1170(ra) # 56ec <printf>
    exit(1);
    3262:	4505                	li	a0,1
    ...
    3272:	b1a50513          	addi	a0,a0,-1254 # 6d88 <statistics+0x14fe>
    3276:	00002097          	auipc	ra,0x2
    327a:	476080e7          	jalr	1142(ra) # 56ec <printf>
    exit(1);
    327e:	4505                	li	a0,1
    ...
    328e:	b2e50513          	addi	a0,a0,-1234 # 6db8 <statistics+0x152e>
    3292:	00002097          	auipc	ra,0x2
    3296:	45a080e7          	jalr	1114(ra) # 56ec <printf>
    exit(1);
    329a:	4505                	li	a0,1
    ...
    32aa:	b3250513          	addi	a0,a0,-1230 # 6dd8 <statistics+0x154e>
    32ae:	00002097          	auipc	ra,0x2
    32b2:	43e080e7          	jalr	1086(ra) # 56ec <printf>
    exit(1);
    32b6:	4505                	li	a0,1
    ...
    32c6:	b3650513          	addi	a0,a0,-1226 # 6df8 <statistics+0x156e>
    32ca:	00002097          	auipc	ra,0x2
    32ce:	422080e7          	jalr	1058(ra) # 56ec <printf>
    exit(1);
    32d2:	4505                	li	a0,1
    ...
    32e2:	b3a50513          	addi	a0,a0,-1222 # 6e18 <statistics+0x158e>
    32e6:	00002097          	auipc	ra,0x2
    32ea:	406080e7          	jalr	1030(ra) # 56ec <printf>
    exit(1);
    32ee:	4505                	li	a0,1
    ...
    32fe:	b4e50513          	addi	a0,a0,-1202 # 6e48 <statistics+0x15be>
    3302:	00002097          	auipc	ra,0x2
    3306:	3ea080e7          	jalr	1002(ra) # 56ec <printf>
    exit(1);
    330a:	4505                	li	a0,1
    ...
    331a:	b5a50513          	addi	a0,a0,-1190 # 6e70 <statistics+0x15e6>
    331e:	00002097          	auipc	ra,0x2
    3322:	3ce080e7          	jalr	974(ra) # 56ec <printf>
    exit(1);
    3326:	4505                	li	a0,1
    ...
    3336:	b6650513          	addi	a0,a0,-1178 # 6e98 <statistics+0x160e>
    333a:	00002097          	auipc	ra,0x2
    333e:	3b2080e7          	jalr	946(ra) # 56ec <printf>
    exit(1);
    3342:	4505                	li	a0,1
    ...
    3352:	b7250513          	addi	a0,a0,-1166 # 6ec0 <statistics+0x1636>
    3356:	00002097          	auipc	ra,0x2
    335a:	396080e7          	jalr	918(ra) # 56ec <printf>
    exit(1);
    335e:	4505                	li	a0,1
    ...
    336e:	b7650513          	addi	a0,a0,-1162 # 6ee0 <statistics+0x1656>
    3372:	00002097          	auipc	ra,0x2
    3376:	37a080e7          	jalr	890(ra) # 56ec <printf>
    exit(1);
    337a:	4505                	li	a0,1
    ...
    338a:	b7a50513          	addi	a0,a0,-1158 # 6f00 <statistics+0x1676>
    338e:	00002097          	auipc	ra,0x2
    3392:	35e080e7          	jalr	862(ra) # 56ec <printf>
    exit(1);
    3396:	4505                	li	a0,1
    ...
    33a6:	b8650513          	addi	a0,a0,-1146 # 6f28 <statistics+0x169e>
    33aa:	00002097          	auipc	ra,0x2
    33ae:	342080e7          	jalr	834(ra) # 56ec <printf>
    exit(1);
    33b2:	4505                	li	a0,1
    ...
    33c2:	b8a50513          	addi	a0,a0,-1142 # 6f48 <statistics+0x16be>
    33c6:	00002097          	auipc	ra,0x2
    33ca:	326080e7          	jalr	806(ra) # 56ec <printf>
    exit(1);
    33ce:	4505                	li	a0,1
    ...
    33de:	b8e50513          	addi	a0,a0,-1138 # 6f68 <statistics+0x16de>
    33e2:	00002097          	auipc	ra,0x2
    33e6:	30a080e7          	jalr	778(ra) # 56ec <printf>
    exit(1);
    33ea:	4505                	li	a0,1
    ...
    33fa:	b9a50513          	addi	a0,a0,-1126 # 6f90 <statistics+0x1706>
    33fe:	00002097          	auipc	ra,0x2
    3402:	2ee080e7          	jalr	750(ra) # 56ec <printf>
    exit(1);
    3406:	4505                	li	a0,1
    ...
    3416:	81650513          	addi	a0,a0,-2026 # 6c28 <statistics+0x139e>
    341a:	00002097          	auipc	ra,0x2
    341e:	2d2080e7          	jalr	722(ra) # 56ec <printf>
    exit(1);
    3422:	4505                	li	a0,1
    ...
    3432:	b8250513          	addi	a0,a0,-1150 # 6fb0 <statistics+0x1726>
    3436:	00002097          	auipc	ra,0x2
    343a:	2b6080e7          	jalr	694(ra) # 56ec <printf>
    exit(1);
    343e:	4505                	li	a0,1
    ...
    344e:	b8650513          	addi	a0,a0,-1146 # 6fd0 <statistics+0x1746>
    3452:	00002097          	auipc	ra,0x2
    3456:	29a080e7          	jalr	666(ra) # 56ec <printf>
    exit(1);
    345a:	4505                	li	a0,1
    ...
    346a:	b9a50513          	addi	a0,a0,-1126 # 7000 <statistics+0x1776>
    346e:	00002097          	auipc	ra,0x2
    3472:	27e080e7          	jalr	638(ra) # 56ec <printf>
    exit(1);
    3476:	4505                	li	a0,1
    ...
    3486:	b9e50513          	addi	a0,a0,-1122 # 7020 <statistics+0x1796>
    348a:	00002097          	auipc	ra,0x2
    348e:	262080e7          	jalr	610(ra) # 56ec <printf>
    exit(1);
    3492:	4505                	li	a0,1
...
000000000000349c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    34ac:	b9050513          	addi	a0,a0,-1136 # 7038 <statistics+0x17ae>
  ...
  if(chdir("dots") != 0){
    ...
    34be:	b7e50513          	addi	a0,a0,-1154 # 7038 <statistics+0x17ae>
  ...
  if(unlink(".") == 0){
    ...
    34d0:	b3450513          	addi	a0,a0,-1228 # 6000 <statistics+0x776>
  ...
  if(unlink("..") == 0){
    ...
    34e2:	baa50513          	addi	a0,a0,-1110 # 7088 <statistics+0x17fe>
  ...
  if(chdir("/") != 0){
    ...
    34f4:	5a050513          	addi	a0,a0,1440 # 6a90 <statistics+0x1206>
  ...
  if(unlink("dots/.") == 0){
    ...
    3506:	ba650513          	addi	a0,a0,-1114 # 70a8 <statistics+0x181e>
  ...
  if(unlink("dots/..") == 0){
    ...
    3518:	bbc50513          	addi	a0,a0,-1092 # 70d0 <statistics+0x1846>
  ...
  if(unlink("dots") != 0){
    ...
    352a:	b1250513          	addi	a0,a0,-1262 # 7038 <statistics+0x17ae>
    ...
    3548:	afc50513          	addi	a0,a0,-1284 # 7040 <statistics+0x17b6>
    354c:	00002097          	auipc	ra,0x2
    3550:	1a0080e7          	jalr	416(ra) # 56ec <printf>
    exit(1);
    3554:	4505                	li	a0,1
    ...
    3564:	af850513          	addi	a0,a0,-1288 # 7058 <statistics+0x17ce>
    3568:	00002097          	auipc	ra,0x2
    356c:	184080e7          	jalr	388(ra) # 56ec <printf>
    exit(1);
    3570:	4505                	li	a0,1
    ...
    3580:	af450513          	addi	a0,a0,-1292 # 7070 <statistics+0x17e6>
    3584:	00002097          	auipc	ra,0x2
    3588:	168080e7          	jalr	360(ra) # 56ec <printf>
    exit(1);
    358c:	4505                	li	a0,1
    ...
    359c:	af850513          	addi	a0,a0,-1288 # 7090 <statistics+0x1806>
    35a0:	00002097          	auipc	ra,0x2
    35a4:	14c080e7          	jalr	332(ra) # 56ec <printf>
    exit(1);
    35a8:	4505                	li	a0,1
    ...
    35b8:	4e450513          	addi	a0,a0,1252 # 6a98 <statistics+0x120e>
    35bc:	00002097          	auipc	ra,0x2
    35c0:	130080e7          	jalr	304(ra) # 56ec <printf>
    exit(1);
    35c4:	4505                	li	a0,1
    ...
    35d4:	ae050513          	addi	a0,a0,-1312 # 70b0 <statistics+0x1826>
    35d8:	00002097          	auipc	ra,0x2
    35dc:	114080e7          	jalr	276(ra) # 56ec <printf>
    exit(1);
    35e0:	4505                	li	a0,1
    ...
    35f0:	aec50513          	addi	a0,a0,-1300 # 70d8 <statistics+0x184e>
    35f4:	00002097          	auipc	ra,0x2
    35f8:	0f8080e7          	jalr	248(ra) # 56ec <printf>
    exit(1);
    35fc:	4505                	li	a0,1
    ...
    360c:	af050513          	addi	a0,a0,-1296 # 70f8 <statistics+0x186e>
    3610:	00002097          	auipc	ra,0x2
    3614:	0dc080e7          	jalr	220(ra) # 56ec <printf>
    exit(1);
    3618:	4505                	li	a0,1
...
0000000000003622 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3638:	ae450513          	addi	a0,a0,-1308 # 7118 <statistics+0x188e>
  ...
  if(chdir("dirfile") == 0){
    ...
    3654:	ac850513          	addi	a0,a0,-1336 # 7118 <statistics+0x188e>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3668:	afc50513          	addi	a0,a0,-1284 # 7160 <statistics+0x18d6>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3680:	ae450513          	addi	a0,a0,-1308 # 7160 <statistics+0x18d6>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3694:	ad050513          	addi	a0,a0,-1328 # 7160 <statistics+0x18d6>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    36a8:	abc50513          	addi	a0,a0,-1348 # 7160 <statistics+0x18d6>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    36bc:	aa858593          	addi	a1,a1,-1368 # 7160 <statistics+0x18d6>
    36c0:	00002517          	auipc	a0,0x2
    36c4:	43050513          	addi	a0,a0,1072 # 5af0 <statistics+0x266>
  ...
  if(unlink("dirfile") != 0){
    ...
    36d8:	a4450513          	addi	a0,a0,-1468 # 7118 <statistics+0x188e>
  ...
  fd = open(".", O_RDWR);
    ...
    36ee:	91650513          	addi	a0,a0,-1770 # 6000 <statistics+0x776>
  ...
  fd = open(".", 0);
    ...
    3704:	90050513          	addi	a0,a0,-1792 # 6000 <statistics+0x776>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3718:	2a458593          	addi	a1,a1,676 # 59b8 <statistics+0x12e>
  ...
  close(fd);
    ...
    3744:	9e050513          	addi	a0,a0,-1568 # 7120 <statistics+0x1896>
    3748:	00002097          	auipc	ra,0x2
    374c:	fa4080e7          	jalr	-92(ra) # 56ec <printf>
    exit(1);
    3750:	4505                	li	a0,1
    ...
    3760:	9e450513          	addi	a0,a0,-1564 # 7140 <statistics+0x18b6>
    3764:	00002097          	auipc	ra,0x2
    3768:	f88080e7          	jalr	-120(ra) # 56ec <printf>
    exit(1);
    376c:	4505                	li	a0,1
    ...
    377c:	9f850513          	addi	a0,a0,-1544 # 7170 <statistics+0x18e6>
    3780:	00002097          	auipc	ra,0x2
    3784:	f6c080e7          	jalr	-148(ra) # 56ec <printf>
    exit(1);
    3788:	4505                	li	a0,1
    ...
    3798:	9dc50513          	addi	a0,a0,-1572 # 7170 <statistics+0x18e6>
    379c:	00002097          	auipc	ra,0x2
    37a0:	f50080e7          	jalr	-176(ra) # 56ec <printf>
    exit(1);
    37a4:	4505                	li	a0,1
    ...
    37b4:	9e850513          	addi	a0,a0,-1560 # 7198 <statistics+0x190e>
    37b8:	00002097          	auipc	ra,0x2
    37bc:	f34080e7          	jalr	-204(ra) # 56ec <printf>
    exit(1);
    37c0:	4505                	li	a0,1
    ...
    37d0:	9f450513          	addi	a0,a0,-1548 # 71c0 <statistics+0x1936>
    37d4:	00002097          	auipc	ra,0x2
    37d8:	f18080e7          	jalr	-232(ra) # 56ec <printf>
    exit(1);
    37dc:	4505                	li	a0,1
    ...
    37ec:	a0050513          	addi	a0,a0,-1536 # 71e8 <statistics+0x195e>
    37f0:	00002097          	auipc	ra,0x2
    37f4:	efc080e7          	jalr	-260(ra) # 56ec <printf>
    exit(1);
    37f8:	4505                	li	a0,1
    ...
    3808:	a0c50513          	addi	a0,a0,-1524 # 7210 <statistics+0x1986>
    380c:	00002097          	auipc	ra,0x2
    3810:	ee0080e7          	jalr	-288(ra) # 56ec <printf>
    exit(1);
    3814:	4505                	li	a0,1
    ...
    3824:	a1050513          	addi	a0,a0,-1520 # 7230 <statistics+0x19a6>
    3828:	00002097          	auipc	ra,0x2
    382c:	ec4080e7          	jalr	-316(ra) # 56ec <printf>
    exit(1);
    3830:	4505                	li	a0,1
    ...
    3840:	a1c50513          	addi	a0,a0,-1508 # 7258 <statistics+0x19ce>
    3844:	00002097          	auipc	ra,0x2
    3848:	ea8080e7          	jalr	-344(ra) # 56ec <printf>
    exit(1);
    384c:	4505                	li	a0,1
...
0000000000003856 <iref>:
{
    ...
    3874:	a00a0a13          	addi	s4,s4,-1536 # 7270 <statistics+0x19e6>
    mkdir("");
    3878:	00003497          	auipc	s1,0x3
    387c:	4f848493          	addi	s1,s1,1272 # 6d70 <statistics+0x14e6>
    link("README", "");
    3880:	00002a97          	auipc	s5,0x2
    3884:	270a8a93          	addi	s5,s5,624 # 5af0 <statistics+0x266>
    fd = open("xx", O_CREATE);
    3888:	00004997          	auipc	s3,0x4
    388c:	8e098993          	addi	s3,s3,-1824 # 7168 <statistics+0x18de>
    3890:	a891                	j	38e4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3892:	85da                	mv	a1,s6
    3894:	00004517          	auipc	a0,0x4
    3898:	9e450513          	addi	a0,a0,-1564 # 7278 <statistics+0x19ee>
    389c:	00002097          	auipc	ra,0x2
    38a0:	e50080e7          	jalr	-432(ra) # 56ec <printf>
      exit(1);
    38a4:	4505                	li	a0,1
    ...
    38b4:	9e050513          	addi	a0,a0,-1568 # 7290 <statistics+0x1a06>
    38b8:	00002097          	auipc	ra,0x2
    38bc:	e34080e7          	jalr	-460(ra) # 56ec <printf>
      exit(1);
    38c0:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3948:	74498993          	addi	s3,s3,1860 # 7088 <statistics+0x17fe>
    unlink("irefd");
    394c:	00004917          	auipc	s2,0x4
    3950:	92490913          	addi	s2,s2,-1756 # 7270 <statistics+0x19e6>
    chdir("..");
    3954:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3970:	12450513          	addi	a0,a0,292 # 6a90 <statistics+0x1206>
...
0000000000003990 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    39a0:	90c50513          	addi	a0,a0,-1780 # 72a8 <statistics+0x1a1e>
  ...
  if(pid == 0){
    ...
    39c4:	8e850513          	addi	a0,a0,-1816 # 72a8 <statistics+0x1a1e>
    ...
    39da:	8f250513          	addi	a0,a0,-1806 # 72c8 <statistics+0x1a3e>
    39de:	00002097          	auipc	ra,0x2
    39e2:	d0e080e7          	jalr	-754(ra) # 56ec <printf>
      exit(1);
    39e6:	4505                	li	a0,1
    ...
    39f6:	8be50513          	addi	a0,a0,-1858 # 72b0 <statistics+0x1a26>
    39fa:	00002097          	auipc	ra,0x2
    39fe:	cf2080e7          	jalr	-782(ra) # 56ec <printf>
    exit(1);
    3a02:	4505                	li	a0,1
    ...
    3a12:	79250513          	addi	a0,a0,1938 # 61a0 <statistics+0x916>
    3a16:	00002097          	auipc	ra,0x2
    3a1a:	cd6080e7          	jalr	-810(ra) # 56ec <printf>
    exit(1);
    3a1e:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3a40:	86c50513          	addi	a0,a0,-1940 # 72a8 <statistics+0x1a1e>
    ...
    3a54:	94050513          	addi	a0,a0,-1728 # 6390 <statistics+0xb06>
    3a58:	00002097          	auipc	ra,0x2
    3a5c:	c94080e7          	jalr	-876(ra) # 56ec <printf>
    exit(1);
    3a60:	4505                	li	a0,1
...
0000000000003a82 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3a92:	86250513          	addi	a0,a0,-1950 # 72f0 <statistics+0x1a66>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3abe:	83650513          	addi	a0,a0,-1994 # 72f0 <statistics+0x1a66>
  ...
  sleep(10); // one second
    ...
    3af6:	86e50513          	addi	a0,a0,-1938 # 6360 <statistics+0xad6>
    3afa:	00002097          	auipc	ra,0x2
    3afe:	bf2080e7          	jalr	-1038(ra) # 56ec <printf>
    exit(1);
    3b02:	4505                	li	a0,1
    ...
    3b10:	7e448493          	addi	s1,s1,2020 # 72f0 <statistics+0x1a66>
    3b14:	4581                	li	a1,0
    3b16:	8526                	mv	a0,s1
...
0000000000003b52 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3b7a:	7ea50513          	addi	a0,a0,2026 # 6360 <statistics+0xad6>
    3b7e:	00002097          	auipc	ra,0x2
    3b82:	b6e080e7          	jalr	-1170(ra) # 56ec <printf>
    exit(1);
    3b86:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3ba8:	5fc50513          	addi	a0,a0,1532 # 61a0 <statistics+0x916>
    3bac:	00002097          	auipc	ra,0x2
    3bb0:	b40080e7          	jalr	-1216(ra) # 56ec <printf>
    exit(1);
    3bb4:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3bec:	dd058593          	addi	a1,a1,-560 # 59b8 <statistics+0x12e>
    ...
    3c16:	58e50513          	addi	a0,a0,1422 # 61a0 <statistics+0x916>
    3c1a:	00002097          	auipc	ra,0x2
    3c1e:	ad2080e7          	jalr	-1326(ra) # 56ec <printf>
     exit(1);
    3c22:	4505                	li	a0,1
    ...
    3c30:	6d450513          	addi	a0,a0,1748 # 7300 <statistics+0x1a76>
    3c34:	00002097          	auipc	ra,0x2
    3c38:	ab8080e7          	jalr	-1352(ra) # 56ec <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3c50:	be458593          	addi	a1,a1,-1052 # b830 <buf>
    ...
    3c6a:	6b250513          	addi	a0,a0,1714 # 7318 <statistics+0x1a8e>
    3c6e:	00002097          	auipc	ra,0x2
    3c72:	a7e080e7          	jalr	-1410(ra) # 56ec <printf>
}
  ...
  printf("kill... ");
    ...
    3c96:	69e50513          	addi	a0,a0,1694 # 7330 <statistics+0x1aa6>
    3c9a:	00002097          	auipc	ra,0x2
    3c9e:	a52080e7          	jalr	-1454(ra) # 56ec <printf>
  kill(pid1);
    3ca2:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    3cc4:	68050513          	addi	a0,a0,1664 # 7340 <statistics+0x1ab6>
    3cc8:	00002097          	auipc	ra,0x2
    3ccc:	a24080e7          	jalr	-1500(ra) # 56ec <printf>
  wait(0);
    3cd0:	4501                	li	a0,0
...
0000000000003cf0 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3d26:	58650513          	addi	a0,a0,1414 # 62a8 <statistics+0xa1e>
    3d2a:	00002097          	auipc	ra,0x2
    3d2e:	9c2080e7          	jalr	-1598(ra) # 56ec <printf>
    exit(1);
    3d32:	4505                	li	a0,1
    ...
    3d5a:	c6258593          	addi	a1,a1,-926 # 59b8 <statistics+0x12e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3e1e:	53650513          	addi	a0,a0,1334 # 7350 <statistics+0x1ac6>
    3e22:	00002097          	auipc	ra,0x2
    3e26:	8ca080e7          	jalr	-1846(ra) # 56ec <printf>
    exit(1);
    3e2a:	4505                	li	a0,1
    ...
    3e3a:	36a50513          	addi	a0,a0,874 # 61a0 <statistics+0x916>
    3e3e:	00002097          	auipc	ra,0x2
    3e42:	8ae080e7          	jalr	-1874(ra) # 56ec <printf>
    exit(1);
    3e46:	4505                	li	a0,1
    ...
    3e70:	6705                	lui	a4,0x1
      n += *(a+i);
    3e72:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f17c0>
    ...
    3e84:	4f050513          	addi	a0,a0,1264 # 7370 <statistics+0x1ae6>
    3e88:	00002097          	auipc	ra,0x2
    3e8c:	864080e7          	jalr	-1948(ra) # 56ec <printf>
    exit(1);
    3e90:	4505                	li	a0,1
...
0000000000003ea4 <reparent>:
{
  ...
  exit(0);
    ...
    3ef8:	2ac50513          	addi	a0,a0,684 # 61a0 <statistics+0x916>
    3efc:	00001097          	auipc	ra,0x1
    3f00:	7f0080e7          	jalr	2032(ra) # 56ec <printf>
      exit(1);
    3f04:	4505                	li	a0,1
    ...
    3f14:	41850513          	addi	a0,a0,1048 # 6328 <statistics+0xa9e>
    3f18:	00001097          	auipc	ra,0x1
    3f1c:	7d4080e7          	jalr	2004(ra) # 56ec <printf>
        exit(1);
    3f20:	4505                	li	a0,1
...
0000000000003f54 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3f9e:	80a080e7          	jalr	-2038(ra) # 57a4 <malloc>
    ...
    3fba:	7ee080e7          	jalr	2030(ra) # 57a4 <malloc>
    if(m1 == 0){
    3fbe:	c911                	beqz	a0,3fd2 <mem+0x7e>
    free(m1);
    3fc0:	00001097          	auipc	ra,0x1
    3fc4:	762080e7          	jalr	1890(ra) # 5722 <free>
    exit(0);
    3fc8:	4501                	li	a0,0
    ...
    3fd8:	3cc50513          	addi	a0,a0,972 # 73a0 <statistics+0x1b16>
    3fdc:	00001097          	auipc	ra,0x1
    3fe0:	710080e7          	jalr	1808(ra) # 56ec <printf>
      exit(1);
    3fe4:	4505                	li	a0,1
...
0000000000003ff8 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    408e:	34650513          	addi	a0,a0,838 # 73d0 <statistics+0x1b46>
    4092:	00001097          	auipc	ra,0x1
    4096:	65a080e7          	jalr	1626(ra) # 56ec <printf>
    exit(1);
    409a:	4505                	li	a0,1
    ...
    40aa:	35250513          	addi	a0,a0,850 # 73f8 <statistics+0x1b6e>
    40ae:	00001097          	auipc	ra,0x1
    40b2:	63e080e7          	jalr	1598(ra) # 56ec <printf>
      exit(1);
    40b6:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    40ee:	2d650513          	addi	a0,a0,726 # 73c0 <statistics+0x1b36>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    412e:	2ee50513          	addi	a0,a0,750 # 7418 <statistics+0x1b8e>
    4132:	00001097          	auipc	ra,0x1
    4136:	5ba080e7          	jalr	1466(ra) # 56ec <printf>
    exit(1);
    413a:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    416a:	25a50513          	addi	a0,a0,602 # 73c0 <statistics+0x1b36>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4190:	2b450513          	addi	a0,a0,692 # 7440 <statistics+0x1bb6>
    4194:	00001097          	auipc	ra,0x1
    4198:	558080e7          	jalr	1368(ra) # 56ec <printf>
    exit(1);
    419c:	4505                	li	a0,1
...
00000000000041b0 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    41d6:	28678793          	addi	a5,a5,646 # 7458 <statistics+0x1bce>
    41da:	f6f43823          	sd	a5,-144(s0)
    41de:	00003797          	auipc	a5,0x3
    41e2:	28278793          	addi	a5,a5,642 # 7460 <statistics+0x1bd6>
    41e6:	f6f43c23          	sd	a5,-136(s0)
    41ea:	00003797          	auipc	a5,0x3
    41ee:	27e78793          	addi	a5,a5,638 # 7468 <statistics+0x1bde>
    41f2:	f8f43023          	sd	a5,-128(s0)
    41f6:	00003797          	auipc	a5,0x3
    41fa:	27a78793          	addi	a5,a5,634 # 7470 <statistics+0x1be6>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4252:	5e2a0a13          	addi	s4,s4,1506 # b830 <buf>
    4256:	00007a97          	auipc	s5,0x7
    425a:	5dba8a93          	addi	s5,s5,1499 # b831 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4272:	32250513          	addi	a0,a0,802 # 6590 <statistics+0xd06>
    4276:	00001097          	auipc	ra,0x1
    427a:	476080e7          	jalr	1142(ra) # 56ec <printf>
      exit(1);
    427e:	4505                	li	a0,1
    ...
    42ee:	18e50513          	addi	a0,a0,398 # 7478 <statistics+0x1bee>
    42f2:	00001097          	auipc	ra,0x1
    42f6:	3fa080e7          	jalr	1018(ra) # 56ec <printf>
        exit(1);
    42fa:	4505                	li	a0,1
    ...
    4308:	18450513          	addi	a0,a0,388 # 7488 <statistics+0x1bfe>
    430c:	00001097          	auipc	ra,0x1
    4310:	3e0080e7          	jalr	992(ra) # 56ec <printf>
          exit(1);
    4314:	4505                	li	a0,1
    ...
    4330:	17450513          	addi	a0,a0,372 # 74a0 <statistics+0x1c16>
    ...
    4360:	4d478793          	addi	a5,a5,1236 # b830 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    43be:	0f650513          	addi	a0,a0,246 # 74b0 <statistics+0x1c26>
    43c2:	00001097          	auipc	ra,0x1
    43c6:	32a080e7          	jalr	810(ra) # 56ec <printf>
      exit(1);
    43ca:	4505                	li	a0,1
...
00000000000043f2 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4420:	0acb8b93          	addi	s7,s7,172 # 74c8 <statistics+0x1c3e>
  for(i = 0; i < N; i++){
    ...
    4462:	07250513          	addi	a0,a0,114 # 74d0 <statistics+0x1c46>
    4466:	00001097          	auipc	ra,0x1
    446a:	286080e7          	jalr	646(ra) # 56ec <printf>
        exit(1);
    446e:	4505                	li	a0,1
    ...
    4480:	04c50513          	addi	a0,a0,76 # 74c8 <statistics+0x1c3e>
  ...
  fd = open(".", 0);
    ...
    44b8:	b4c50513          	addi	a0,a0,-1204 # 6000 <statistics+0x776>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4530:	fc450513          	addi	a0,a0,-60 # 74f0 <statistics+0x1c66>
    4534:	00001097          	auipc	ra,0x1
    4538:	1b8080e7          	jalr	440(ra) # 56ec <printf>
        exit(1);
    453c:	4505                	li	a0,1
    ...
    4550:	fc450513          	addi	a0,a0,-60 # 7510 <statistics+0x1c86>
  ...
  for(i = 0; i < N; i++){
    ...
    4588:	fb450513          	addi	a0,a0,-76 # 7538 <statistics+0x1cae>
    ...
    45a4:	c0050513          	addi	a0,a0,-1024 # 61a0 <statistics+0x916>
...
000000000000474e <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    478e:	0a690913          	addi	s2,s2,166 # b830 <buf>
  for(i = 0; i < N; i++){
    4792:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    47d6:	d9e50513          	addi	a0,a0,-610 # 7570 <statistics+0x1ce6>
  ...
  for(i = 0; ; i++){
    ...
    47ec:	04890913          	addi	s2,s2,72 # b830 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    483a:	d4a50513          	addi	a0,a0,-694 # 7580 <statistics+0x1cf6>
    ...
    4856:	d4e50513          	addi	a0,a0,-690 # 75a0 <statistics+0x1d16>
    ...
    4872:	d5250513          	addi	a0,a0,-686 # 75c0 <statistics+0x1d36>
    ...
    488e:	d5650513          	addi	a0,a0,-682 # 75e0 <statistics+0x1d56>
    ...
    48aa:	d5a50513          	addi	a0,a0,-678 # 7600 <statistics+0x1d76>
    ...
    48c6:	d5650513          	addi	a0,a0,-682 # 7618 <statistics+0x1d8e>
  ...
  unlink("bigfile.dat");
    ...
    48f4:	c8050513          	addi	a0,a0,-896 # 7570 <statistics+0x1ce6>
    ...
    4918:	d2450513          	addi	a0,a0,-732 # 7638 <statistics+0x1dae>
...
000000000000492e <dirtest>:
{
  ...
  printf("mkdir test\n");
    ...
    493e:	d1e50513          	addi	a0,a0,-738 # 7658 <statistics+0x1dce>
    4942:	00001097          	auipc	ra,0x1
    4946:	daa080e7          	jalr	-598(ra) # 56ec <printf>
  if(mkdir("dir0") < 0){
    494a:	00003517          	auipc	a0,0x3
    494e:	d1e50513          	addi	a0,a0,-738 # 7668 <statistics+0x1dde>
  ...
  if(chdir("dir0") < 0){
    ...
    4962:	d0a50513          	addi	a0,a0,-758 # 7668 <statistics+0x1dde>
  ...
  if(chdir("..") < 0){
    ...
    4976:	71650513          	addi	a0,a0,1814 # 7088 <statistics+0x17fe>
  ...
  if(unlink("dir0") < 0){
    ...
    498a:	ce250513          	addi	a0,a0,-798 # 7668 <statistics+0x1dde>
  ...
  printf("%s: mkdir test ok\n");
    ...
    499e:	d1e50513          	addi	a0,a0,-738 # 76b8 <statistics+0x1e2e>
    ...
    49ba:	07250513          	addi	a0,a0,114 # 6a28 <statistics+0x119e>
    ...
    49d6:	c9e50513          	addi	a0,a0,-866 # 7670 <statistics+0x1de6>
    ...
    49f2:	c9a50513          	addi	a0,a0,-870 # 7688 <statistics+0x1dfe>
    ...
    4a0e:	c9650513          	addi	a0,a0,-874 # 76a0 <statistics+0x1e16>
...
0000000000004a24 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4a46:	c8e50513          	addi	a0,a0,-882 # 76d0 <statistics+0x1e46>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4a66:	c7ec8c93          	addi	s9,s9,-898 # 76e0 <statistics+0x1e56>
    int total = 0;
    4a6a:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4a6c:	00007a17          	auipc	s4,0x7
    4a70:	dc4a0a13          	addi	s4,s4,-572 # b830 <buf>
    name[0] = 'f';
    ...
    4ae0:	c1450513          	addi	a0,a0,-1004 # 76f0 <statistics+0x1e66>
  ...
  printf("fsfull test finished\n");
    ...
    4b56:	bce50513          	addi	a0,a0,-1074 # 7720 <statistics+0x1e96>
    ...
    4ba6:	b6650513          	addi	a0,a0,-1178 # 7708 <statistics+0x1e7e>
...
0000000000004bc4 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4bce:	43670713          	addi	a4,a4,1078 # 8000 <randstate>
    4bd2:	6308                	ld	a0,0(a4)
    4bd4:	001967b7          	lui	a5,0x196
    4bd8:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187dcd>
    4bdc:	02f50533          	mul	a0,a0,a5
    4be0:	3c6ef7b7          	lui	a5,0x3c6ef
    4be4:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e0b1f>
...
0000000000004bf4 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4c68:	ad450513          	addi	a0,a0,-1324 # 7738 <statistics+0x1eae>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4c80:	d3c58593          	addi	a1,a1,-708 # 59b8 <statistics+0x12e>
    ...
    4c96:	ac650513          	addi	a0,a0,-1338 # 7758 <statistics+0x1ece>
    ...
    4cb0:	a9450513          	addi	a0,a0,-1388 # 7740 <statistics+0x1eb6>
    ...
    4cca:	a7a50513          	addi	a0,a0,-1414 # 7740 <statistics+0x1eb6>
  ...
  unlink("junk");
    ...
    4cee:	a4e50513          	addi	a0,a0,-1458 # 7738 <statistics+0x1eae>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4d44:	c7898993          	addi	s3,s3,-904 # 59b8 <statistics+0x12e>
      uint64 a = (uint64) sbrk(4096);
    ...
    4d76:	a3650513          	addi	a0,a0,-1482 # 77a8 <statistics+0x1f1e>
    ...
    4d90:	9dc50513          	addi	a0,a0,-1572 # 7768 <statistics+0x1ede>
    ...
    4daa:	9e250513          	addi	a0,a0,-1566 # 7788 <statistics+0x1efe>
  ...
  while(1){
    ...
    4df8:	9d450513          	addi	a0,a0,-1580 # 77c8 <statistics+0x1f3e>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4e48:	9a450513          	addi	a0,a0,-1628 # 77e8 <statistics+0x1f5e>
  ...
  if(pid == 0) {
    ...
    4e78:	99c50513          	addi	a0,a0,-1636 # 7810 <statistics+0x1f86>
    ...
    4e9c:	96050513          	addi	a0,a0,-1696 # 77f8 <statistics+0x1f6e>
    ...
    4ec4:	95850513          	addi	a0,a0,-1704 # 7818 <statistics+0x1f8e>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    4f0c:	cd078793          	addi	a5,a5,-816 # 7bd8 <statistics+0x234e>
    4f10:	c4040713          	addi	a4,s0,-960
    4f14:	00003817          	auipc	a6,0x3
    4f18:	04480813          	addi	a6,a6,68 # 7f58 <statistics+0x26ce>
  ...
  printf("usertests starting\n");
    ...
    4f3c:	99850513          	addi	a0,a0,-1640 # 78d0 <statistics+0x2046>
  ...
  if(fail){
    ...
    4f74:	91850513          	addi	a0,a0,-1768 # 7888 <statistics+0x1ffe>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    4f90:	89458593          	addi	a1,a1,-1900 # 7820 <statistics+0x1f96>
    ...
    4fa6:	96658593          	addi	a1,a1,-1690 # 7908 <statistics+0x207e>
    ...
    4fca:	86250513          	addi	a0,a0,-1950 # 7828 <statistics+0x1f9e>
  ...
  if(fail){
    ...
    5036:	83e50513          	addi	a0,a0,-1986 # 7870 <statistics+0x1fe6>
    ...
    5050:	86c50513          	addi	a0,a0,-1940 # 78b8 <statistics+0x202e>
    ...
    50ae:	b2e78793          	addi	a5,a5,-1234 # 7bd8 <statistics+0x234e>
    50b2:	c4040713          	addi	a4,s0,-960
    50b6:	00003817          	auipc	a6,0x3
    50ba:	ea280813          	addi	a6,a6,-350 # 7f58 <statistics+0x26ce>
    ...
    50de:	80e50513          	addi	a0,a0,-2034 # 78e8 <statistics+0x205e>
    50e2:	00000097          	auipc	ra,0x0
    50e6:	60a080e7          	jalr	1546(ra) # 56ec <printf>
        printf("SOME TESTS FAILED\n");
    50ea:	00002a97          	auipc	s5,0x2
    50ee:	786a8a93          	addi	s5,s5,1926 # 7870 <statistics+0x1fe6>
        if(continuous != 2)
    50f2:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    50f4:	00002b17          	auipc	s6,0x2
    50f8:	75cb0b13          	addi	s6,s6,1884 # 7850 <statistics+0x1fc6>
...
putc(int fd, char c)
{
    5412:	1101                	addi	sp,sp,-32
    5414:	ec06                	sd	ra,24(sp)
    5416:	e822                	sd	s0,16(sp)
    5418:	1000                	addi	s0,sp,32
    541a:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    541e:	4605                	li	a2,1
    5420:	fef40593          	addi	a1,s0,-17
    5424:	00000097          	auipc	ra,0x0
    5428:	f66080e7          	jalr	-154(ra) # 538a <write>
}
    542c:	60e2                	ld	ra,24(sp)
    542e:	6442                	ld	s0,16(sp)
    5430:	6105                	addi	sp,sp,32
    5432:	8082                	ret

0000000000005434 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    543c:	f04a                	sd	s2,32(sp)
    543e:	ec4e                	sd	s3,24(sp)
    5440:	0080                	addi	s0,sp,64
    5442:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    5444:	c299                	beqz	a3,544a <printint+0x16>
    5446:	0805c963          	bltz	a1,54d8 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    544a:	2581                	sext.w	a1,a1
  neg = 0;
    544c:	4881                	li	a7,0
    544e:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5454:	2601                	sext.w	a2,a2
    5456:	00003517          	auipc	a0,0x3
    545a:	b6250513          	addi	a0,a0,-1182 # 7fb8 <digits>
    545e:	883a                	mv	a6,a4
    5460:	2705                	addiw	a4,a4,1
    5462:	02c5f7bb          	remuw	a5,a1,a2
    5466:	1782                	slli	a5,a5,0x20
    5468:	9381                	srli	a5,a5,0x20
    546a:	97aa                	add	a5,a5,a0
    546c:	0007c783          	lbu	a5,0(a5)
    5470:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5474:	0005879b          	sext.w	a5,a1
    5478:	02c5d5bb          	divuw	a1,a1,a2
    547c:	0685                	addi	a3,a3,1
    547e:	fec7f0e3          	bgeu	a5,a2,545e <printint+0x2a>
  if(neg)
    5482:	00088c63          	beqz	a7,549a <printint+0x66>
    buf[i++] = '-';
    5486:	fd070793          	addi	a5,a4,-48
    548a:	00878733          	add	a4,a5,s0
    548e:	02d00793          	li	a5,45
    5492:	fef70823          	sb	a5,-16(a4)
    5496:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    549a:	02e05863          	blez	a4,54ca <printint+0x96>
    ...
    54c0:	f56080e7          	jalr	-170(ra) # 5412 <putc>
  while(--i >= 0)
    54c4:	197d                	addi	s2,s2,-1
    54c6:	ff3918e3          	bne	s2,s3,54b6 <printint+0x82>
}
    ...
    54dc:	4885                	li	a7,1
    x = -xx;
    54de:	bf85                	j	544e <printint+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5514:	4c55                	li	s8,21
    5516:	00003c97          	auipc	s9,0x3
    551a:	a4ac8c93          	addi	s9,s9,-1462 # 7f60 <statistics+0x26d6>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    551e:	02800d93          	li	s11,40
  putc(fd, 'x');
    5522:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5524:	00003b97          	auipc	s7,0x3
    5528:	a94b8b93          	addi	s7,s7,-1388 # 7fb8 <digits>
    552c:	a839                	j	554a <vprintf+0x6a>
        putc(fd, c);
    552e:	85ca                	mv	a1,s2
    5530:	8556                	mv	a0,s5
    5532:	00000097          	auipc	ra,0x0
    5536:	ee0080e7          	jalr	-288(ra) # 5412 <putc>
    553a:	a019                	j	5540 <vprintf+0x60>
    } else if(state == '%'){
    553c:	01498d63          	beq	s3,s4,5556 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5540:	0485                	addi	s1,s1,1
    5542:	fff4c903          	lbu	s2,-1(s1)
    5546:	14090d63          	beqz	s2,56a0 <vprintf+0x1c0>
    if(state == 0){
    554a:	fe0999e3          	bnez	s3,553c <vprintf+0x5c>
      if(c == '%'){
    554e:	ff4910e3          	bne	s2,s4,552e <vprintf+0x4e>
        state = '%';
    5552:	89d2                	mv	s3,s4
    5554:	b7f5                	j	5540 <vprintf+0x60>
      if(c == 'd'){
    5556:	11490c63          	beq	s2,s4,566e <vprintf+0x18e>
    555a:	f9d9079b          	addiw	a5,s2,-99
    555e:	0ff7f793          	zext.b	a5,a5
    5562:	10fc6e63          	bltu	s8,a5,567e <vprintf+0x19e>
    5566:	f9d9079b          	addiw	a5,s2,-99
    556a:	0ff7f713          	zext.b	a4,a5
    556e:	10ec6863          	bltu	s8,a4,567e <vprintf+0x19e>
    5572:	00271793          	slli	a5,a4,0x2
    5576:	97e6                	add	a5,a5,s9
    5578:	439c                	lw	a5,0(a5)
    557a:	97e6                	add	a5,a5,s9
    557c:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    557e:	008b0913          	addi	s2,s6,8
    5582:	4685                	li	a3,1
    5584:	4629                	li	a2,10
    5586:	000b2583          	lw	a1,0(s6)
    558a:	8556                	mv	a0,s5
    558c:	00000097          	auipc	ra,0x0
    5590:	ea8080e7          	jalr	-344(ra) # 5434 <printint>
    5594:	8b4a                	mv	s6,s2
      } else {
    ...
    55ac:	e8c080e7          	jalr	-372(ra) # 5434 <printint>
    55b0:	8b4a                	mv	s6,s2
      state = 0;
    55b2:	4981                	li	s3,0
    ...
    55c8:	e70080e7          	jalr	-400(ra) # 5434 <printint>
    55cc:	8b4a                	mv	s6,s2
      state = 0;
    55ce:	4981                	li	s3,0
    55d0:	bf85                	j	5540 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    55d2:	008b0793          	addi	a5,s6,8
    55d6:	f8f43423          	sd	a5,-120(s0)
    55da:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    55de:	03000593          	li	a1,48
    55e2:	8556                	mv	a0,s5
    55e4:	00000097          	auipc	ra,0x0
    55e8:	e2e080e7          	jalr	-466(ra) # 5412 <putc>
  putc(fd, 'x');
    55ec:	07800593          	li	a1,120
    55f0:	8556                	mv	a0,s5
    55f2:	00000097          	auipc	ra,0x0
    55f6:	e20080e7          	jalr	-480(ra) # 5412 <putc>
    55fa:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    55fc:	03c9d793          	srli	a5,s3,0x3c
    5600:	97de                	add	a5,a5,s7
    5602:	0007c583          	lbu	a1,0(a5)
    5606:	8556                	mv	a0,s5
    5608:	00000097          	auipc	ra,0x0
    560c:	e0a080e7          	jalr	-502(ra) # 5412 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5610:	0992                	slli	s3,s3,0x4
    5612:	397d                	addiw	s2,s2,-1
    5614:	fe0914e3          	bnez	s2,55fc <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5618:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    561c:	4981                	li	s3,0
    561e:	b70d                	j	5540 <vprintf+0x60>
        s = va_arg(ap, char*);
    5620:	008b0913          	addi	s2,s6,8
    5624:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5628:	02098163          	beqz	s3,564a <vprintf+0x16a>
        while(*s != 0){
    562c:	0009c583          	lbu	a1,0(s3)
    5630:	c5ad                	beqz	a1,569a <vprintf+0x1ba>
          putc(fd, *s);
    5632:	8556                	mv	a0,s5
    5634:	00000097          	auipc	ra,0x0
    5638:	dde080e7          	jalr	-546(ra) # 5412 <putc>
          s++;
    563c:	0985                	addi	s3,s3,1
        while(*s != 0){
    563e:	0009c583          	lbu	a1,0(s3)
    5642:	f9e5                	bnez	a1,5632 <vprintf+0x152>
        s = va_arg(ap, char*);
    5644:	8b4a                	mv	s6,s2
      state = 0;
    5646:	4981                	li	s3,0
    5648:	bde5                	j	5540 <vprintf+0x60>
          s = "(null)";
    564a:	00003997          	auipc	s3,0x3
    564e:	90e98993          	addi	s3,s3,-1778 # 7f58 <statistics+0x26ce>
        while(*s != 0){
    5652:	85ee                	mv	a1,s11
    5654:	bff9                	j	5632 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5656:	008b0913          	addi	s2,s6,8
    565a:	000b4583          	lbu	a1,0(s6)
    565e:	8556                	mv	a0,s5
    5660:	00000097          	auipc	ra,0x0
    5664:	db2080e7          	jalr	-590(ra) # 5412 <putc>
    5668:	8b4a                	mv	s6,s2
      state = 0;
    566a:	4981                	li	s3,0
    566c:	bdd1                	j	5540 <vprintf+0x60>
        putc(fd, c);
    566e:	85d2                	mv	a1,s4
    5670:	8556                	mv	a0,s5
    5672:	00000097          	auipc	ra,0x0
    5676:	da0080e7          	jalr	-608(ra) # 5412 <putc>
      state = 0;
    567a:	4981                	li	s3,0
    567c:	b5d1                	j	5540 <vprintf+0x60>
        putc(fd, '%');
    567e:	85d2                	mv	a1,s4
    5680:	8556                	mv	a0,s5
    5682:	00000097          	auipc	ra,0x0
    5686:	d90080e7          	jalr	-624(ra) # 5412 <putc>
        putc(fd, c);
    568a:	85ca                	mv	a1,s2
    568c:	8556                	mv	a0,s5
    568e:	00000097          	auipc	ra,0x0
    5692:	d84080e7          	jalr	-636(ra) # 5412 <putc>
      state = 0;
    5696:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    572c:	00003797          	auipc	a5,0x3
    5730:	8e47b783          	ld	a5,-1820(a5) # 8010 <freep>
    5734:	a02d                	j	575e <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5736:	4618                	lw	a4,8(a2)
    5738:	9f2d                	addw	a4,a4,a1
    573a:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    573e:	6398                	ld	a4,0(a5)
    5740:	6310                	ld	a2,0(a4)
    5742:	a83d                	j	5780 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5744:	ff852703          	lw	a4,-8(a0)
    5748:	9f31                	addw	a4,a4,a2
    574a:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    574c:	ff053683          	ld	a3,-16(a0)
    5750:	a091                	j	5794 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5752:	6398                	ld	a4,0(a5)
    5754:	00e7e463          	bltu	a5,a4,575c <free+0x3a>
    5758:	00e6ea63          	bltu	a3,a4,576c <free+0x4a>
{
    575c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    575e:	fed7fae3          	bgeu	a5,a3,5752 <free+0x30>
    5762:	6398                	ld	a4,0(a5)
    5764:	00e6e463          	bltu	a3,a4,576c <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5768:	fee7eae3          	bltu	a5,a4,575c <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    ...
    577c:	fae60de3          	beq	a2,a4,5736 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    5790:	fae68ae3          	beq	a3,a4,5744 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5794:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5796:	00003717          	auipc	a4,0x3
    579a:	86f73d23          	sd	a5,-1926(a4) # 8010 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    57cc:	84853503          	ld	a0,-1976(a0) # 8010 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    57f0:	00003917          	auipc	s2,0x3
    57f4:	82090913          	addi	s2,s2,-2016 # 8010 <freep>
  if(p == (char*)-1)
    57f8:	5afd                	li	s5,-1
    57fa:	a895                	j	586e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    57fc:	00009797          	auipc	a5,0x9
    5800:	03478793          	addi	a5,a5,52 # e830 <base>
    5804:	00003717          	auipc	a4,0x3
    5808:	80f73623          	sd	a5,-2036(a4) # 8010 <freep>
    ...
    5830:	7ea73223          	sd	a0,2020(a4) # 8010 <freep>
      return (void*)(p + 1);
  ...
  free((void*)(hp + 1));
    ...
    585c:	eca080e7          	jalr	-310(ra) # 5722 <free>
  return freep;
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    587e:	b78080e7          	jalr	-1160(ra) # 53f2 <sbrk>
  if(p == (char*)-1)
...
{
    588a:	7179                	addi	sp,sp,-48
    588c:	f406                	sd	ra,40(sp)
    588e:	f022                	sd	s0,32(sp)
    5890:	ec26                	sd	s1,24(sp)
    5892:	e84a                	sd	s2,16(sp)
    5894:	e44e                	sd	s3,8(sp)
    5896:	e052                	sd	s4,0(sp)
  ...
  fd = open("statistics", O_RDONLY);
    589e:	4581                	li	a1,0
    58a0:	00002517          	auipc	a0,0x2
    58a4:	73050513          	addi	a0,a0,1840 # 7fd0 <digits+0x18>
    58a8:	00000097          	auipc	ra,0x0
    58ac:	b02080e7          	jalr	-1278(ra) # 53aa <open>
  if(fd < 0) {
    58b0:	04054263          	bltz	a0,58f4 <statistics+0x6a>
    58b4:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    58b6:	4481                	li	s1,0
    58b8:	03205063          	blez	s2,58d8 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    58bc:	4099063b          	subw	a2,s2,s1
    58c0:	009a05b3          	add	a1,s4,s1
    58c4:	854e                	mv	a0,s3
    58c6:	00000097          	auipc	ra,0x0
    58ca:	abc080e7          	jalr	-1348(ra) # 5382 <read>
    58ce:	00054563          	bltz	a0,58d8 <statistics+0x4e>
      break;
    }
    i += n;
    58d2:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    58d4:	ff24c4e3          	blt	s1,s2,58bc <statistics+0x32>
  }
  close(fd);
    58d8:	854e                	mv	a0,s3
    58da:	00000097          	auipc	ra,0x0
    58de:	ab8080e7          	jalr	-1352(ra) # 5392 <close>
  return i;
}
    58e2:	8526                	mv	a0,s1
    58e4:	70a2                	ld	ra,40(sp)
    58e6:	7402                	ld	s0,32(sp)
    58e8:	64e2                	ld	s1,24(sp)
    58ea:	6942                	ld	s2,16(sp)
    58ec:	69a2                	ld	s3,8(sp)
    58ee:	6a02                	ld	s4,0(sp)
    58f0:	6145                	addi	sp,sp,48
    58f2:	8082                	ret
      fprintf(2, "stats: open failed\n");
    58f4:	00002597          	auipc	a1,0x2
    58f8:	6ec58593          	addi	a1,a1,1772 # 7fe0 <digits+0x28>
    58fc:	4509                	li	a0,2
    58fe:	00000097          	auipc	ra,0x0
    5902:	dc0080e7          	jalr	-576(ra) # 56be <fprintf>
      exit(1);
    5906:	4505                	li	a0,1
    5908:	00000097          	auipc	ra,0x0
    590c:	a62080e7          	jalr	-1438(ra) # 536a <exit>
