...
void print_recv_msg(char* content){
   ...
   e:	8a650513          	addi	a0,a0,-1882 # 8b0 <malloc+0xea>
  12:	00000097          	auipc	ra,0x0
  16:	6fc080e7          	jalr	1788(ra) # 70e <printf>
}
  1a:	60a2                	ld	ra,8(sp)
  1c:	6402                	ld	s0,0(sp)
...
int main(int argc,char* argv[]){
  ...
  34:	374080e7          	jalr	884(ra) # 3a4 <pipe>
    write(p[1], "ping", 4);
  38:	4611                	li	a2,4
  3a:	00001597          	auipc	a1,0x1
  3e:	88658593          	addi	a1,a1,-1914 # 8c0 <malloc+0xfa>
  42:	fdc42503          	lw	a0,-36(s0)
  46:	00000097          	auipc	ra,0x0
  4a:	36e080e7          	jalr	878(ra) # 3b4 <write>
    if((pid_c=fork())==0){
  4e:	00000097          	auipc	ra,0x0
  52:	33e080e7          	jalr	830(ra) # 38c <fork>
  56:	e52d                	bnez	a0,c0 <main+0x9e>
        char* read_out=""; 
        close(p[1]);
  58:	fdc42503          	lw	a0,-36(s0)
  5c:	00000097          	auipc	ra,0x0
  60:	360080e7          	jalr	864(ra) # 3bc <close>
        read(p[0], read_out, 4);
  64:	4611                	li	a2,4
  66:	00001597          	auipc	a1,0x1
  6a:	87258593          	addi	a1,a1,-1934 # 8d8 <malloc+0x112>
  6e:	fd842503          	lw	a0,-40(s0)
  72:	00000097          	auipc	ra,0x0
  76:	33a080e7          	jalr	826(ra) # 3ac <read>
        close(p[0]);
  7a:	fd842503          	lw	a0,-40(s0)
  7e:	00000097          	auipc	ra,0x0
  82:	33e080e7          	jalr	830(ra) # 3bc <close>
        printf("%d: received %s\n",pid_c, read_out);
  86:	00001617          	auipc	a2,0x1
  8a:	85260613          	addi	a2,a2,-1966 # 8d8 <malloc+0x112>
  8e:	4581                	li	a1,0
  90:	00001517          	auipc	a0,0x1
  94:	83850513          	addi	a0,a0,-1992 # 8c8 <malloc+0x102>
  98:	00000097          	auipc	ra,0x0
  9c:	676080e7          	jalr	1654(ra) # 70e <printf>
        write(p[1], "pong", 4);
  a0:	4611                	li	a2,4
  a2:	00001597          	auipc	a1,0x1
  a6:	83e58593          	addi	a1,a1,-1986 # 8e0 <malloc+0x11a>
  aa:	fdc42503          	lw	a0,-36(s0)
  ae:	00000097          	auipc	ra,0x0
  b2:	306080e7          	jalr	774(ra) # 3b4 <write>
        exit(0);
  b6:	4501                	li	a0,0
  b8:	00000097          	auipc	ra,0x0
  bc:	2dc080e7          	jalr	732(ra) # 394 <exit>
    }else{
        pid_p = getpid();
  ...
  c8:	84aa                	mv	s1,a0
        wait(&stat);
  ca:	fd440513          	addi	a0,s0,-44
  ce:	00000097          	auipc	ra,0x0
  d2:	2ce080e7          	jalr	718(ra) # 39c <wait>
        close(p[1]);
  d6:	fdc42503          	lw	a0,-36(s0)
  da:	00000097          	auipc	ra,0x0
  de:	2e2080e7          	jalr	738(ra) # 3bc <close>
        char* read_out="";
        read(p[0], read_out, 4);
  e2:	4611                	li	a2,4
  e4:	00000597          	auipc	a1,0x0
  e8:	7f458593          	addi	a1,a1,2036 # 8d8 <malloc+0x112>
  ec:	fd842503          	lw	a0,-40(s0)
  f0:	00000097          	auipc	ra,0x0
  f4:	2bc080e7          	jalr	700(ra) # 3ac <read>
        printf("%d: received %s\n",pid_p, read_out);
  f8:	00000617          	auipc	a2,0x0
  fc:	7e060613          	addi	a2,a2,2016 # 8d8 <malloc+0x112>
 100:	85a6                	mv	a1,s1
 102:	00000517          	auipc	a0,0x0
 106:	7c650513          	addi	a0,a0,1990 # 8c8 <malloc+0x102>
 10a:	00000097          	auipc	ra,0x0
 10e:	604080e7          	jalr	1540(ra) # 70e <printf>
        close(p[0]);
 112:	fd842503          	lw	a0,-40(s0)
 116:	00000097          	auipc	ra,0x0
 11a:	2a6080e7          	jalr	678(ra) # 3bc <close>
        exit(0);
 11e:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47c:	4d050513          	addi	a0,a0,1232 # 948 <digits>
 480:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53c:	3b8c8c93          	addi	s9,s9,952 # 8f0 <malloc+0x12a>
 ...
 54a:	402b8b93          	addi	s7,s7,1026 # 948 <digits>
 ...
 670:	27c98993          	addi	s3,s3,636 # 8e8 <malloc+0x122>
        while(*s != 0){
 674:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 752:	2127b783          	ld	a5,530(a5) # 960 <freep>
 ...
 77a:	00e6ea63          	bltu	a3,a4,78e <free+0x4a>
{
 ...
 7bc:	1af73423          	sd	a5,424(a4) # 960 <freep>
}
 7c0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ee:	17653503          	ld	a0,374(a0) # 960 <freep>
 ...
 816:	14e90913          	addi	s2,s2,334 # 960 <freep>
  if(p == (char*)-1)
 81a:	5afd                	li	s5,-1
 81c:	a895                	j	890 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 81e:	00000797          	auipc	a5,0x0
 822:	14a78793          	addi	a5,a5,330 # 968 <base>
 826:	00000717          	auipc	a4,0x0
 82a:	12f73d23          	sd	a5,314(a4) # 960 <freep>
 82e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 852:	10a73923          	sd	a0,274(a4) # 960 <freep>
      return (void*)(p + 1);
