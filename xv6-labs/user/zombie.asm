...
printint(int fd, int xx, int base, int sgn)
{
 ...
 386:	51e50513          	addi	a0,a0,1310 # 8a0 <digits>
 38a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 446:	406c8c93          	addi	s9,s9,1030 # 848 <statistics+0x92>
 ...
 454:	450b8b93          	addi	s7,s7,1104 # 8a0 <digits>
 ...
 57a:	2ca98993          	addi	s3,s3,714 # 840 <statistics+0x8a>
        while(*s != 0){
 57e:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 65c:	2887b783          	ld	a5,648(a5) # 8e0 <freep>
 ...
 684:	00e6ea63          	bltu	a3,a4,698 <free+0x4a>
{
 ...
 6c6:	20f73f23          	sd	a5,542(a4) # 8e0 <freep>
}
 6ca:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6f8:	1ec53503          	ld	a0,492(a0) # 8e0 <freep>
 ...
 720:	1c490913          	addi	s2,s2,452 # 8e0 <freep>
  if(p == (char*)-1)
 724:	5afd                	li	s5,-1
 726:	a895                	j	79a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 728:	00000797          	auipc	a5,0x0
 72c:	1c078793          	addi	a5,a5,448 # 8e8 <base>
 730:	00000717          	auipc	a4,0x0
 734:	1af73823          	sd	a5,432(a4) # 8e0 <freep>
 738:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 75c:	18a73423          	sd	a0,392(a4) # 8e0 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 7d8:	b02080e7          	jalr	-1278(ra) # 2d6 <open>
  if(fd < 0) {
 ...
 7f6:	abc080e7          	jalr	-1348(ra) # 2ae <read>
 ...
 80a:	ab8080e7          	jalr	-1352(ra) # 2be <close>
  return i;
}
 80e:	8526                	mv	a0,s1
 ...
 838:	a62080e7          	jalr	-1438(ra) # 296 <exit>
