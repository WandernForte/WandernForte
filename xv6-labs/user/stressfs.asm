...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 528:	444c8c93          	addi	s9,s9,1092 # 968 <statistics+0xd0>
 ...
 536:	48eb8b93          	addi	s7,s7,1166 # 9c0 <digits>
 ...
 65c:	30898993          	addi	s3,s3,776 # 960 <statistics+0xc8>
        while(*s != 0){
 660:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 73e:	2c67b783          	ld	a5,710(a5) # a00 <freep>
 ...
 766:	00e6ea63          	bltu	a3,a4,77a <free+0x4a>
{
 ...
 7a8:	24f73e23          	sd	a5,604(a4) # a00 <freep>
}
 7ac:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7da:	22a53503          	ld	a0,554(a0) # a00 <freep>
 ...
 802:	20290913          	addi	s2,s2,514 # a00 <freep>
  if(p == (char*)-1)
 806:	5afd                	li	s5,-1
 808:	a895                	j	87c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 80a:	00000797          	auipc	a5,0x0
 80e:	1fe78793          	addi	a5,a5,510 # a08 <base>
 812:	00000717          	auipc	a4,0x0
 816:	1ef73723          	sd	a5,494(a4) # a00 <freep>
 81a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 83e:	1ca73323          	sd	a0,454(a4) # a00 <freep>
      return (void*)(p + 1);
