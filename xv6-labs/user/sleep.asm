...
int main(int argc,char* argv[]){
  ...
  12:	7ca50513          	addi	a0,a0,1994 # 7d8 <malloc+0xe6>
  16:	00000097          	auipc	ra,0x0
  1a:	624080e7          	jalr	1572(ra) # 63a <printf>
        exit(-1);
  1e:	557d                	li	a0,-1
  20:	00000097          	auipc	ra,0x0
  24:	2a0080e7          	jalr	672(ra) # 2c0 <exit>
    }
  ...
  36:	31e080e7          	jalr	798(ra) # 350 <sleep>
    printf("(nothing happens for a little while)\n");
  3a:	00000517          	auipc	a0,0x0
  3e:	7be50513          	addi	a0,a0,1982 # 7f8 <malloc+0x106>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a8:	4dc50513          	addi	a0,a0,1244 # 880 <digits>
 3ac:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 468:	3c4c8c93          	addi	s9,s9,964 # 828 <malloc+0x136>
 ...
 476:	40eb8b93          	addi	s7,s7,1038 # 880 <digits>
 ...
 59c:	28898993          	addi	s3,s3,648 # 820 <malloc+0x12e>
        while(*s != 0){
 5a0:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 67e:	21e7b783          	ld	a5,542(a5) # 898 <freep>
 ...
 6a6:	00e6ea63          	bltu	a3,a4,6ba <free+0x4a>
{
 ...
 6e8:	1af73a23          	sd	a5,436(a4) # 898 <freep>
}
 6ec:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 71a:	18253503          	ld	a0,386(a0) # 898 <freep>
 ...
 742:	15a90913          	addi	s2,s2,346 # 898 <freep>
  if(p == (char*)-1)
 746:	5afd                	li	s5,-1
 748:	a895                	j	7bc <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 74a:	00000797          	auipc	a5,0x0
 74e:	15678793          	addi	a5,a5,342 # 8a0 <base>
 752:	00000717          	auipc	a4,0x0
 756:	14f73323          	sd	a5,326(a4) # 898 <freep>
 75a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 77e:	10a73f23          	sd	a0,286(a4) # 898 <freep>
      return (void*)(p + 1);
