...
wc(int fd, char *name)
{
  ...
  32:	a6bd8d93          	addi	s11,s11,-1429 # a99 <buf+0x1>
  ...
  3c:	970a0a13          	addi	s4,s4,-1680 # 9a8 <statistics+0x86>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  7a:	a2258593          	addi	a1,a1,-1502 # a98 <buf>
  ...
  92:	a0a48493          	addi	s1,s1,-1526 # a98 <buf>
  ...
  ba:	90a50513          	addi	a0,a0,-1782 # 9c0 <statistics+0x9e>
  ...
  e8:	8cc50513          	addi	a0,a0,-1844 # 9b0 <statistics+0x8e>
...
main(int argc, char *argv[])
{
 ...
 162:	87258593          	addi	a1,a1,-1934 # 9d0 <statistics+0xae>
 166:	4501                	li	a0,0
 ...
 180:	85c50513          	addi	a0,a0,-1956 # 9d8 <statistics+0xb6>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b2:	44ac8c93          	addi	s9,s9,1098 # 9f8 <statistics+0xd6>
 ...
 5c0:	494b8b93          	addi	s7,s7,1172 # a50 <digits>
 ...
 6e6:	30e98993          	addi	s3,s3,782 # 9f0 <statistics+0xce>
        while(*s != 0){
 6ea:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 7c8:	2cc7b783          	ld	a5,716(a5) # a90 <freep>
 ...
 7f0:	00e6ea63          	bltu	a3,a4,804 <free+0x4a>
{
 ...
 832:	26f73123          	sd	a5,610(a4) # a90 <freep>
}
 836:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 864:	23053503          	ld	a0,560(a0) # a90 <freep>
 ...
 88c:	20890913          	addi	s2,s2,520 # a90 <freep>
  if(p == (char*)-1)
 890:	5afd                	li	s5,-1
 892:	a895                	j	906 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 894:	00000797          	auipc	a5,0x0
 898:	40478793          	addi	a5,a5,1028 # c98 <base>
 89c:	00000717          	auipc	a4,0x0
 8a0:	1ef73a23          	sd	a5,500(a4) # a90 <freep>
 8a4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8c8:	1ca73623          	sd	a0,460(a4) # a90 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 93c:	13050513          	addi	a0,a0,304 # a68 <digits+0x18>
 940:	00000097          	auipc	ra,0x0
 944:	b02080e7          	jalr	-1278(ra) # 442 <open>
  if(fd < 0) {
 948:	04054263          	bltz	a0,98c <statistics+0x6a>
 94c:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 94e:	4481                	li	s1,0
 950:	03205063          	blez	s2,970 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 954:	4099063b          	subw	a2,s2,s1
 958:	009a05b3          	add	a1,s4,s1
 95c:	854e                	mv	a0,s3
 95e:	00000097          	auipc	ra,0x0
 962:	abc080e7          	jalr	-1348(ra) # 41a <read>
 966:	00054563          	bltz	a0,970 <statistics+0x4e>
      break;
    }
    i += n;
 96a:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 96c:	ff24c4e3          	blt	s1,s2,954 <statistics+0x32>
  }
  close(fd);
 970:	854e                	mv	a0,s3
 972:	00000097          	auipc	ra,0x0
 976:	ab8080e7          	jalr	-1352(ra) # 42a <close>
  return i;
}
 97a:	8526                	mv	a0,s1
 97c:	70a2                	ld	ra,40(sp)
 97e:	7402                	ld	s0,32(sp)
 980:	64e2                	ld	s1,24(sp)
 982:	6942                	ld	s2,16(sp)
 984:	69a2                	ld	s3,8(sp)
 986:	6a02                	ld	s4,0(sp)
 988:	6145                	addi	sp,sp,48
 98a:	8082                	ret
      fprintf(2, "stats: open failed\n");
 98c:	00000597          	auipc	a1,0x0
 990:	0ec58593          	addi	a1,a1,236 # a78 <digits+0x28>
 994:	4509                	li	a0,2
 996:	00000097          	auipc	ra,0x0
 99a:	dc0080e7          	jalr	-576(ra) # 756 <fprintf>
      exit(1);
 99e:	4505                	li	a0,1
 9a0:	00000097          	auipc	ra,0x0
 9a4:	a62080e7          	jalr	-1438(ra) # 402 <exit>
