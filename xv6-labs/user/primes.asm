...
int main(int argc,char* argv[]){
  ...
  16:	8fe48493          	addi	s1,s1,-1794 # 910 <nums>
    // close(p[1]);
    wait(&stat);
    if(sizeof nums>0){
        printf("%d",nums[0]);
  1a:	00001997          	auipc	s3,0x1
  1e:	87698993          	addi	s3,s3,-1930 # 890 <malloc+0xe6>
    pipe(p);
  22:	fb040513          	addi	a0,s0,-80
  26:	00000097          	auipc	ra,0x0
  2a:	362080e7          	jalr	866(ra) # 388 <pipe>
    if((pid=fork())<0){//子进程
  2e:	00000097          	auipc	ra,0x0
  32:	342080e7          	jalr	834(ra) # 370 <fork>
  36:	892a                	mv	s2,a0
  38:	02054963          	bltz	a0,6a <main+0x6a>
    else if(pid==0){
  3c:	cd05                	beqz	a0,74 <main+0x74>
    write(p[1], nums, 34);//init
  3e:	02200613          	li	a2,34
  42:	85a6                	mv	a1,s1
  44:	fb442503          	lw	a0,-76(s0)
  48:	00000097          	auipc	ra,0x0
  4c:	350080e7          	jalr	848(ra) # 398 <write>
    wait(&stat);
  50:	fbc40513          	addi	a0,s0,-68
  54:	00000097          	auipc	ra,0x0
  58:	32c080e7          	jalr	812(ra) # 380 <wait>
        printf("%d",nums[0]);
  5c:	408c                	lw	a1,0(s1)
  5e:	854e                	mv	a0,s3
  ...
  64:	692080e7          	jalr	1682(ra) # 6f2 <printf>
        goto start;
  68:	bf6d                	j	22 <main+0x22>
        exit(-1);
  6a:	557d                	li	a0,-1
  6c:	00000097          	auipc	ra,0x0
  70:	30c080e7          	jalr	780(ra) # 378 <exit>
    int port_out=dup(p[0]);
  74:	fb042503          	lw	a0,-80(s0)
  78:	00000097          	auipc	ra,0x0
  7c:	378080e7          	jalr	888(ra) # 3f0 <dup>
  80:	8aaa                	mv	s5,a0
    read(port_out, nums, 34);
  82:	02200613          	li	a2,34
  86:	00001597          	auipc	a1,0x1
  8a:	88a58593          	addi	a1,a1,-1910 # 910 <nums>
  8e:	00000097          	auipc	ra,0x0
  92:	302080e7          	jalr	770(ra) # 390 <read>
    int port_in=dup(p[1]);
  96:	fb442503          	lw	a0,-76(s0)
  9a:	00000097          	auipc	ra,0x0
  9e:	356080e7          	jalr	854(ra) # 3f0 <dup>
  a2:	8a2a                	mv	s4,a0
    for(int i=1;i<(sizeof nums)/4;i++){
  a4:	00001497          	auipc	s1,0x1
  a8:	87048493          	addi	s1,s1,-1936 # 914 <nums+0x4>
  ac:	00001997          	auipc	s3,0x1
  b0:	8ec98993          	addi	s3,s3,-1812 # 998 <freep>
  b4:	a021                	j	bc <main+0xbc>
  b6:	0491                	addi	s1,s1,4
  b8:	03348363          	beq	s1,s3,de <main+0xde>
        if(nums[i]%flag[0]!=0){
  bc:	409c                	lw	a5,0(s1)
  be:	00002703          	lw	a4,0(zero) # 0 <main>
  c2:	02e7e7bb          	remw	a5,a5,a4
  c6:	dbe5                	beqz	a5,b6 <main+0xb6>
        sleep(1);
  c8:	4505                	li	a0,1
  ca:	00000097          	auipc	ra,0x0
  ce:	33e080e7          	jalr	830(ra) # 408 <sleep>
        num2Next[cnt]=nums[i];
  d2:	4098                	lw	a4,0(s1)
  d4:	00291793          	slli	a5,s2,0x2
  d8:	c398                	sw	a4,0(a5)
        cnt++;
  da:	2905                	addiw	s2,s2,1
  dc:	bfe9                	j	b6 <main+0xb6>
    p[0]=port_out,p[1]=port_in;
  de:	fb542823          	sw	s5,-80(s0)
  e2:	fb442a23          	sw	s4,-76(s0)
    write(port_in, num2Next, 34);
  e6:	02200613          	li	a2,34
  ea:	4581                	li	a1,0
  ec:	8552                	mv	a0,s4
  ee:	00000097          	auipc	ra,0x0
  f2:	2aa080e7          	jalr	682(ra) # 398 <write>
    wait(&stat);
  f6:	fbc40513          	addi	a0,s0,-68
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 460:	49c50513          	addi	a0,a0,1180 # 8f8 <digits>
 464:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 520:	384c8c93          	addi	s9,s9,900 # 8a0 <malloc+0xf6>
 ...
 52e:	3ceb8b93          	addi	s7,s7,974 # 8f8 <digits>
 ...
 654:	24898993          	addi	s3,s3,584 # 898 <malloc+0xee>
        while(*s != 0){
 658:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 736:	2667b783          	ld	a5,614(a5) # 998 <freep>
 ...
 75e:	00e6ea63          	bltu	a3,a4,772 <free+0x4a>
{
 ...
 7a0:	1ef73e23          	sd	a5,508(a4) # 998 <freep>
}
 7a4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7d2:	1ca53503          	ld	a0,458(a0) # 998 <freep>
 ...
 7fa:	1a290913          	addi	s2,s2,418 # 998 <freep>
  if(p == (char*)-1)
 7fe:	5afd                	li	s5,-1
 800:	a895                	j	874 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 802:	00000797          	auipc	a5,0x0
 806:	19e78793          	addi	a5,a5,414 # 9a0 <base>
 80a:	00000717          	auipc	a4,0x0
 80e:	18f73723          	sd	a5,398(a4) # 998 <freep>
 812:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 836:	16a73323          	sd	a0,358(a4) # 998 <freep>
      return (void*)(p + 1);
