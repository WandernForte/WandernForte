...
int main(int argc,char* argv[]){
   ...
   8:	0080                	addi	s0,sp,64
    ...
    // int* flag={0};
    pipe(p);
   a:	fd040513          	addi	a0,s0,-48
   e:	00000097          	auipc	ra,0x0
  12:	396080e7          	jalr	918(ra) # 3a4 <pipe>
    if((pid=fork())!=0){//父进程
  16:	00000097          	auipc	ra,0x0
  1a:	376080e7          	jalr	886(ra) # 38c <fork>
  1e:	cd15                	beqz	a0,5a <main+0x5a>
        
        write(p[1], nums, sizeof nums);
  20:	08800613          	li	a2,136
  24:	00001597          	auipc	a1,0x1
  28:	92458593          	addi	a1,a1,-1756 # 948 <nums>
  2c:	fd442503          	lw	a0,-44(s0)
  30:	00000097          	auipc	ra,0x0
  34:	384080e7          	jalr	900(ra) # 3b4 <write>
        close(p[1]);
  38:	fd442503          	lw	a0,-44(s0)
  3c:	00000097          	auipc	ra,0x0
  40:	380080e7          	jalr	896(ra) # 3bc <close>
        wait(&stat);
  44:	fdc40513          	addi	a0,s0,-36
  48:	00000097          	auipc	ra,0x0
  4c:	354080e7          	jalr	852(ra) # 39c <wait>
    //     printf("%d",nums[0]);
    //     goto start;
    // }
    // exit(0);
  ...
  56:	342080e7          	jalr	834(ra) # 394 <exit>
    int read_out=-1;
  5a:	57fd                	li	a5,-1
  5c:	fcf42023          	sw	a5,-64(s0)
    if(!read(p[0],&read_out,sizeof read_out)){
  60:	4611                	li	a2,4
  62:	fc040593          	addi	a1,s0,-64
  66:	fd042503          	lw	a0,-48(s0)
  6a:	00000097          	auipc	ra,0x0
  6e:	342080e7          	jalr	834(ra) # 3ac <read>
  72:	e509                	bnez	a0,7c <main+0x7c>
        exit(0);
  74:	00000097          	auipc	ra,0x0
  78:	320080e7          	jalr	800(ra) # 394 <exit>
    int prime=read_out;
  7c:	fc042583          	lw	a1,-64(s0)
  80:	fcb42223          	sw	a1,-60(s0)
    printf("prime: %d", prime);
  84:	00001517          	auipc	a0,0x1
  88:	82c50513          	addi	a0,a0,-2004 # 8b0 <malloc+0xea>
  8c:	00000097          	auipc	ra,0x0
  90:	682080e7          	jalr	1666(ra) # 70e <printf>
    printf("\n");
  94:	00001517          	auipc	a0,0x1
  98:	83450513          	addi	a0,a0,-1996 # 8c8 <malloc+0x102>
  9c:	00000097          	auipc	ra,0x0
  a0:	672080e7          	jalr	1650(ra) # 70e <printf>
    pipe(new_ports);//第二个管道
  a4:	fc840513          	addi	a0,s0,-56
  a8:	00000097          	auipc	ra,0x0
  ac:	2fc080e7          	jalr	764(ra) # 3a4 <pipe>
            printf("runned%d\n",read_out);
  b0:	00001497          	auipc	s1,0x1
  b4:	81048493          	addi	s1,s1,-2032 # 8c0 <malloc+0xfa>
    while(read(p[0], &read_out,sizeof read_out)>0){//管道还能读出数据(问题：发生阻塞）
  b8:	4611                	li	a2,4
  ba:	fc040593          	addi	a1,s0,-64
  be:	fd042503          	lw	a0,-48(s0)
  c2:	00000097          	auipc	ra,0x0
  c6:	2ea080e7          	jalr	746(ra) # 3ac <read>
  ca:	04a05463          	blez	a0,112 <main+0x112>
        if(read_out%prime!=0){
  ce:	fc042583          	lw	a1,-64(s0)
  d2:	fc442783          	lw	a5,-60(s0)
  d6:	02f5e7bb          	remw	a5,a1,a5
  da:	dff9                	beqz	a5,b8 <main+0xb8>
            printf("runned%d\n",read_out);
  dc:	8526                	mv	a0,s1
  de:	00000097          	auipc	ra,0x0
  e2:	630080e7          	jalr	1584(ra) # 70e <printf>
            dup(new_ports[1]);
  e6:	fcc42503          	lw	a0,-52(s0)
  ea:	00000097          	auipc	ra,0x0
  ee:	322080e7          	jalr	802(ra) # 40c <dup>
            write(new_ports[1], &prime,1);
  f2:	4605                	li	a2,1
  f4:	fc440593          	addi	a1,s0,-60
  f8:	fcc42503          	lw	a0,-52(s0)
  fc:	00000097          	auipc	ra,0x0
 100:	2b8080e7          	jalr	696(ra) # 3b4 <write>
            close(new_ports[1]);
 104:	fcc42503          	lw	a0,-52(s0)
 108:	00000097          	auipc	ra,0x0
 10c:	2b4080e7          	jalr	692(ra) # 3bc <close>
 110:	b765                	j	b8 <main+0xb8>
    wait(&stat);
 112:	fdc40513          	addi	a0,s0,-36
 116:	00000097          	auipc	ra,0x0
 11a:	286080e7          	jalr	646(ra) # 39c <wait>
    exit(0);
 11e:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53c:	3a0c8c93          	addi	s9,s9,928 # 8d8 <malloc+0x112>
 ...
 670:	26498993          	addi	s3,s3,612 # 8d0 <malloc+0x10a>
        while(*s != 0){
 674:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 752:	2827b783          	ld	a5,642(a5) # 9d0 <freep>
 ...
 77a:	00e6ea63          	bltu	a3,a4,78e <free+0x4a>
{
 ...
 7bc:	20f73c23          	sd	a5,536(a4) # 9d0 <freep>
}
 7c0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ee:	1e653503          	ld	a0,486(a0) # 9d0 <freep>
 ...
 816:	1be90913          	addi	s2,s2,446 # 9d0 <freep>
  if(p == (char*)-1)
 81a:	5afd                	li	s5,-1
 81c:	a895                	j	890 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 81e:	00000797          	auipc	a5,0x0
 822:	1ba78793          	addi	a5,a5,442 # 9d8 <base>
 826:	00000717          	auipc	a4,0x0
 82a:	1af73523          	sd	a5,426(a4) # 9d0 <freep>
 82e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 852:	18a73123          	sd	a0,386(a4) # 9d0 <freep>
      return (void*)(p + 1);
