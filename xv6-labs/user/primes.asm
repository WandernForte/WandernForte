...
void primes(int*ports, int max){
   ...
   8:	f14a                	sd	s2,160(sp)
   a:	ed4e                	sd	s3,152(sp)
   c:	0180                	addi	s0,sp,192
   e:	892a                	mv	s2,a0
  10:	89ae                	mv	s3,a1
    int prime,read_out;
    int num2Next[34]={-1};
  12:	08800613          	li	a2,136
  16:	4581                	li	a1,0
  18:	f4040513          	addi	a0,s0,-192
  1c:	00000097          	auipc	ra,0x0
  20:	1b2080e7          	jalr	434(ra) # 1ce <memset>
  24:	57fd                	li	a5,-1
  26:	f4f42023          	sw	a5,-192(s0)
    int cnt=0;
    int len=read(ports[0],&prime,sizeof prime);
  2a:	4611                	li	a2,4
  2c:	fcc40593          	addi	a1,s0,-52
  30:	00092503          	lw	a0,0(s2)
  34:	00000097          	auipc	ra,0x0
  38:	3ac080e7          	jalr	940(ra) # 3e0 <read>
  3c:	84aa                	mv	s1,a0
    printf("prime %d\n",prime);
  3e:	fcc42583          	lw	a1,-52(s0)
  42:	00001517          	auipc	a0,0x1
  46:	89e50513          	addi	a0,a0,-1890 # 8e0 <malloc+0xe6>
  4a:	00000097          	auipc	ra,0x0
  4e:	6f8080e7          	jalr	1784(ra) # 742 <printf>
    if(len <=0||prime==max) exit(0);
  52:	00905763          	blez	s1,60 <primes+0x60>
  56:	fcc42783          	lw	a5,-52(s0)
    int cnt=0;
  5a:	4481                	li	s1,0
    if(len <=0||prime==max) exit(0);
  5c:	01379963          	bne	a5,s3,6e <primes+0x6e>
  60:	4501                	li	a0,0
  ...
  66:	366080e7          	jalr	870(ra) # 3c8 <exit>
        ...
        if(read_out>=max){
  6a:	03375d63          	bge	a4,s3,a4 <primes+0xa4>
    while(read(ports[0], &read_out,sizeof read_out)>0){//管道还能读出数据
  6e:	4611                	li	a2,4
  70:	fc840593          	addi	a1,s0,-56
  74:	00092503          	lw	a0,0(s2)
  78:	00000097          	auipc	ra,0x0
  7c:	368080e7          	jalr	872(ra) # 3e0 <read>
  80:	02a05263          	blez	a0,a4 <primes+0xa4>
        if(read_out%prime!=0){
  84:	fc842703          	lw	a4,-56(s0)
  88:	fcc42783          	lw	a5,-52(s0)
  8c:	02f767bb          	remw	a5,a4,a5
  90:	dfe9                	beqz	a5,6a <primes+0x6a>
            num2Next[cnt] = read_out;
  92:	00249793          	slli	a5,s1,0x2
  96:	fd078793          	addi	a5,a5,-48
  9a:	97a2                	add	a5,a5,s0
  9c:	f6e7a823          	sw	a4,-144(a5)
            cnt++;
  a0:	2485                	addiw	s1,s1,1
  a2:	b7e1                	j	6a <primes+0x6a>
            break;
        }
    }
    write(ports[1], num2Next, cnt*4);
  a4:	0024961b          	slliw	a2,s1,0x2
  a8:	f4040593          	addi	a1,s0,-192
  ac:	00492503          	lw	a0,4(s2)
  b0:	00000097          	auipc	ra,0x0
  b4:	338080e7          	jalr	824(ra) # 3e8 <write>
    
    if(fork() == 0){ //child's turn
  b8:	00000097          	auipc	ra,0x0
  bc:	308080e7          	jalr	776(ra) # 3c0 <fork>
  c0:	cd09                	beqz	a0,da <primes+0xda>
  ...
  c8:	30c080e7          	jalr	780(ra) # 3d0 <wait>
    return;
}
  cc:	70ea                	ld	ra,184(sp)
  ce:	744a                	ld	s0,176(sp)
  d0:	74aa                	ld	s1,168(sp)
  d2:	790a                	ld	s2,160(sp)
  d4:	69ea                	ld	s3,152(sp)
  d6:	6129                	addi	sp,sp,192
  d8:	8082                	ret
        primes(ports, num2Next[cnt-1]);
  da:	fff4879b          	addiw	a5,s1,-1
  de:	078a                	slli	a5,a5,0x2
  e0:	fd078793          	addi	a5,a5,-48
  e4:	97a2                	add	a5,a5,s0
  e6:	f707a583          	lw	a1,-144(a5)
  ea:	854a                	mv	a0,s2
  ec:	00000097          	auipc	ra,0x0
  f0:	f14080e7          	jalr	-236(ra) # 0 <primes>
        exit(0);
  f4:	4501                	li	a0,0
  f6:	00000097          	auipc	ra,0x0
  fa:	2d2080e7          	jalr	722(ra) # 3c8 <exit>

00000000000000fe <main>:
int main(int argc,char* argv[]){
  fe:	1101                	addi	sp,sp,-32
 100:	ec06                	sd	ra,24(sp)
 102:	e822                	sd	s0,16(sp)
 104:	1000                	addi	s0,sp,32
    int p[2];
    pipe(p);
 106:	fe840513          	addi	a0,s0,-24
 10a:	00000097          	auipc	ra,0x0
 10e:	2ce080e7          	jalr	718(ra) # 3d8 <pipe>
    write(p[1],nums,sizeof nums);
 112:	08800613          	li	a2,136
 116:	00001597          	auipc	a1,0x1
 11a:	85258593          	addi	a1,a1,-1966 # 968 <nums>
 11e:	fec42503          	lw	a0,-20(s0)
 122:	00000097          	auipc	ra,0x0
 126:	2c6080e7          	jalr	710(ra) # 3e8 <write>
    primes(p, 35);
 12a:	02300593          	li	a1,35
 12e:	fe840513          	addi	a0,s0,-24
 132:	00000097          	auipc	ra,0x0
 136:	ece080e7          	jalr	-306(ra) # 0 <primes>
    
    close(p[1]);
 13a:	fec42503          	lw	a0,-20(s0)
 13e:	00000097          	auipc	ra,0x0
 142:	2b2080e7          	jalr	690(ra) # 3f0 <close>
    close(p[0]);
 146:	fe842503          	lw	a0,-24(s0)
...
free(void *ap)
{
 ...
 786:	26e7b783          	ld	a5,622(a5) # 9f0 <freep>
 ...
 7ae:	00e6ea63          	bltu	a3,a4,7c2 <free+0x4a>
{
 ...
 7f0:	20f73223          	sd	a5,516(a4) # 9f0 <freep>
}
 7f4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 822:	1d253503          	ld	a0,466(a0) # 9f0 <freep>
 ...
 84a:	1aa90913          	addi	s2,s2,426 # 9f0 <freep>
  if(p == (char*)-1)
 84e:	5afd                	li	s5,-1
 850:	a895                	j	8c4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 852:	00000797          	auipc	a5,0x0
 856:	1a678793          	addi	a5,a5,422 # 9f8 <base>
 85a:	00000717          	auipc	a4,0x0
 85e:	18f73b23          	sd	a5,406(a4) # 9f0 <freep>
 862:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 886:	16a73723          	sd	a0,366(a4) # 9f0 <freep>
      return (void*)(p + 1);
