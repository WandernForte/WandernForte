...
main(int argc, char *argv[])
{
  ...
  2e:	86ea0a13          	addi	s4,s4,-1938 # 898 <statistics+0x88>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	83858593          	addi	a1,a1,-1992 # 8a0 <statistics+0x90>
  70:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a0:	414c8c93          	addi	s9,s9,1044 # 8b0 <statistics+0xa0>
 ...
 4ae:	45eb8b93          	addi	s7,s7,1118 # 908 <digits>
 ...
 5d4:	2d898993          	addi	s3,s3,728 # 8a8 <statistics+0x98>
        while(*s != 0){
 5d8:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6b6:	2967b783          	ld	a5,662(a5) # 948 <freep>
 ...
 6de:	00e6ea63          	bltu	a3,a4,6f2 <free+0x4a>
{
 ...
 720:	22f73623          	sd	a5,556(a4) # 948 <freep>
}
 724:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 752:	1fa53503          	ld	a0,506(a0) # 948 <freep>
 ...
 77a:	1d290913          	addi	s2,s2,466 # 948 <freep>
  if(p == (char*)-1)
 77e:	5afd                	li	s5,-1
 780:	a895                	j	7f4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 782:	00000797          	auipc	a5,0x0
 786:	1ce78793          	addi	a5,a5,462 # 950 <base>
 78a:	00000717          	auipc	a4,0x0
 78e:	1af73f23          	sd	a5,446(a4) # 948 <freep>
 792:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b6:	18a73b23          	sd	a0,406(a4) # 948 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 816:	ec26                	sd	s1,24(sp)
 818:	e84a                	sd	s2,16(sp)
 81a:	e44e                	sd	s3,8(sp)
 81c:	e052                	sd	s4,0(sp)
 ...
 82a:	0fa50513          	addi	a0,a0,250 # 920 <digits+0x18>
 82e:	00000097          	auipc	ra,0x0
 832:	b02080e7          	jalr	-1278(ra) # 330 <open>
  if(fd < 0) {
 836:	04054263          	bltz	a0,87a <statistics+0x6a>
 83a:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 83c:	4481                	li	s1,0
 83e:	03205063          	blez	s2,85e <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 842:	4099063b          	subw	a2,s2,s1
 846:	009a05b3          	add	a1,s4,s1
 84a:	854e                	mv	a0,s3
 84c:	00000097          	auipc	ra,0x0
 850:	abc080e7          	jalr	-1348(ra) # 308 <read>
 854:	00054563          	bltz	a0,85e <statistics+0x4e>
      break;
    }
    i += n;
 858:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 85a:	ff24c4e3          	blt	s1,s2,842 <statistics+0x32>
  }
  close(fd);
 85e:	854e                	mv	a0,s3
 860:	00000097          	auipc	ra,0x0
 864:	ab8080e7          	jalr	-1352(ra) # 318 <close>
  return i;
}
 868:	8526                	mv	a0,s1
 ...
 87e:	0b658593          	addi	a1,a1,182 # 930 <digits+0x28>
 882:	4509                	li	a0,2
 884:	00000097          	auipc	ra,0x0
 888:	dc0080e7          	jalr	-576(ra) # 644 <fprintf>
      exit(1);
 88c:	4505                	li	a0,1
 88e:	00000097          	auipc	ra,0x0
 892:	a62080e7          	jalr	-1438(ra) # 2f0 <exit>
