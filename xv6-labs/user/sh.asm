...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	36058593          	addi	a1,a1,864 # 1370 <statistics+0x88>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	31a58593          	addi	a1,a1,794 # 1378 <statistics+0x90>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2e850513          	addi	a0,a0,744 # 1380 <statistics+0x98>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3bc70713          	addi	a4,a4,956 # 1480 <statistics+0x198>
    ...
    panic("runcmd");
      ...
      e2:	2aa50513          	addi	a0,a0,682 # 1388 <statistics+0xa0>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	29058593          	addi	a1,a1,656 # 1390 <statistics+0xa8>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	25458593          	addi	a1,a1,596 # 13a0 <statistics+0xb8>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	1ce50513          	addi	a0,a0,462 # 13b0 <statistics+0xc8>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3fe:	15e98993          	addi	s3,s3,350 # 1558 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     464:	0f898993          	addi	s3,s3,248 # 1558 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d0:	08c98993          	addi	s3,s3,140 # 1558 <whitespace>
     4d4:	00001a97          	auipc	s5,0x1
     4d8:	07ca8a93          	addi	s5,s5,124 # 1550 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     53c:	02098993          	addi	s3,s3,32 # 1558 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ae:	e2eb8b93          	addi	s7,s7,-466 # 13d8 <statistics+0xf0>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c0:	dfc50513          	addi	a0,a0,-516 # 13b8 <statistics+0xd0>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a8:	d3c60613          	addi	a2,a2,-708 # 13e0 <statistics+0xf8>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d8:	d2cb0b13          	addi	s6,s6,-724 # 1400 <statistics+0x118>
  ...
  return ret;
     ...
     712:	cda50513          	addi	a0,a0,-806 # 13e8 <statistics+0x100>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     774:	c8050513          	addi	a0,a0,-896 # 13f0 <statistics+0x108>
...
000000000000078e <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ae:	c5e60613          	addi	a2,a2,-930 # 1408 <statistics+0x120>
     7b2:	85ce                	mv	a1,s3
     7b4:	854a                	mv	a0,s2
...
00000000000007fc <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     81e:	bf6a0a13          	addi	s4,s4,-1034 # 1410 <statistics+0x128>
  ...
  if(peek(ps, es, ";")){
     ...
     854:	bc860613          	addi	a2,a2,-1080 # 1418 <statistics+0x130>
     858:	85ce                	mv	a1,s3
     85a:	854a                	mv	a0,s2
...
00000000000008a4 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8ba:	b2a60613          	addi	a2,a2,-1238 # 13e0 <statistics+0xf8>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ea:	b4a60613          	addi	a2,a2,-1206 # 1430 <statistics+0x148>
     8ee:	85ca                	mv	a1,s2
     8f0:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92c:	af850513          	addi	a0,a0,-1288 # 1420 <statistics+0x138>
     930:	fffff097          	auipc	ra,0xfffff
     934:	724080e7          	jalr	1828(ra) # 54 <panic>
    panic("syntax - missing )");
     938:	00001517          	auipc	a0,0x1
     93c:	b0050513          	addi	a0,a0,-1280 # 1438 <statistics+0x150>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     968:	b3470713          	addi	a4,a4,-1228 # 1498 <statistics+0x1b0>
...
00000000000009e0 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a14:	a4060613          	addi	a2,a2,-1472 # 1450 <statistics+0x168>
     a18:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4a:	a1258593          	addi	a1,a1,-1518 # 1458 <statistics+0x170>
     a4e:	4509                	li	a0,2
     a50:	00000097          	auipc	ra,0x0
     a54:	6cc080e7          	jalr	1740(ra) # 111c <fprintf>
    panic("syntax");
     a58:	00001517          	auipc	a0,0x1
     a5c:	99050513          	addi	a0,a0,-1648 # 13e8 <statistics+0x100>
...
0000000000000a68 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a7e:	9ee48493          	addi	s1,s1,-1554 # 1468 <statistics+0x180>
     a82:	4589                	li	a1,2
     a84:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa4:	ac848493          	addi	s1,s1,-1336 # 1568 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa8:	06300913          	li	s2,99
     aac:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     ab0:	00001a17          	auipc	s4,0x1
     ab4:	abba0a13          	addi	s4,s4,-1349 # 156b <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab8:	00001a97          	auipc	s5,0x1
     abc:	9b8a8a93          	addi	s5,s5,-1608 # 1470 <statistics+0x188>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b3e:	a2e50513          	addi	a0,a0,-1490 # 1568 <buf.0>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     eb8:	65c50513          	addi	a0,a0,1628 # 1510 <digits>
     ebc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     f78:	544c8c93          	addi	s9,s9,1348 # 14b8 <statistics+0x1d0>
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f86:	58eb8b93          	addi	s7,s7,1422 # 1510 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10ac:	40898993          	addi	s3,s3,1032 # 14b0 <statistics+0x1c8>
        while(*s != 0){
    10b0:	85ee                	mv	a1,s11
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    118e:	3d67b783          	ld	a5,982(a5) # 1560 <freep>
    ...
    11b6:	00e6ea63          	bltu	a3,a4,11ca <free+0x4a>
{
  ...
  freep = p;
    ...
    11f8:	36f73623          	sd	a5,876(a4) # 1560 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    122a:	33a53503          	ld	a0,826(a0) # 1560 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1252:	31290913          	addi	s2,s2,786 # 1560 <freep>
  if(p == (char*)-1)
    1256:	5afd                	li	s5,-1
    1258:	a895                	j	12cc <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    125a:	00000797          	auipc	a5,0x0
    125e:	37678793          	addi	a5,a5,886 # 15d0 <base>
    1262:	00000717          	auipc	a4,0x0
    1266:	2ef73f23          	sd	a5,766(a4) # 1560 <freep>
    ...
    128e:	2ca73b23          	sd	a0,726(a4) # 1560 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
    ...
    12ee:	ec26                	sd	s1,24(sp)
    12f0:	e84a                	sd	s2,16(sp)
    12f2:	e44e                	sd	s3,8(sp)
    12f4:	e052                	sd	s4,0(sp)
    12f6:	1800                	addi	s0,sp,48
    12f8:	8a2a                	mv	s4,a0
    12fa:	892e                	mv	s2,a1
  int fd, i, n;
  ...
  fd = open("statistics", O_RDONLY);
    ...
    1302:	22a50513          	addi	a0,a0,554 # 1528 <digits+0x18>
    1306:	00000097          	auipc	ra,0x0
    130a:	b02080e7          	jalr	-1278(ra) # e08 <open>
  if(fd < 0) {
    130e:	04054263          	bltz	a0,1352 <statistics+0x6a>
    1312:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    1314:	4481                	li	s1,0
    1316:	03205063          	blez	s2,1336 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    131a:	4099063b          	subw	a2,s2,s1
    131e:	009a05b3          	add	a1,s4,s1
    1322:	854e                	mv	a0,s3
    1324:	00000097          	auipc	ra,0x0
    1328:	abc080e7          	jalr	-1348(ra) # de0 <read>
    132c:	00054563          	bltz	a0,1336 <statistics+0x4e>
      break;
    }
    i += n;
    1330:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    1332:	ff24c4e3          	blt	s1,s2,131a <statistics+0x32>
  }
  close(fd);
    1336:	854e                	mv	a0,s3
    1338:	00000097          	auipc	ra,0x0
    133c:	ab8080e7          	jalr	-1352(ra) # df0 <close>
  return i;
}
    1340:	8526                	mv	a0,s1
    1342:	70a2                	ld	ra,40(sp)
    1344:	7402                	ld	s0,32(sp)
    1346:	64e2                	ld	s1,24(sp)
    1348:	6942                	ld	s2,16(sp)
    134a:	69a2                	ld	s3,8(sp)
    134c:	6a02                	ld	s4,0(sp)
    134e:	6145                	addi	sp,sp,48
    1350:	8082                	ret
      fprintf(2, "stats: open failed\n");
    1352:	00000597          	auipc	a1,0x0
    1356:	1e658593          	addi	a1,a1,486 # 1538 <digits+0x28>
    135a:	4509                	li	a0,2
    135c:	00000097          	auipc	ra,0x0
    1360:	dc0080e7          	jalr	-576(ra) # 111c <fprintf>
      exit(1);
    1364:	4505                	li	a0,1
    1366:	00000097          	auipc	ra,0x0
    136a:	a62080e7          	jalr	-1438(ra) # dc8 <exit>
