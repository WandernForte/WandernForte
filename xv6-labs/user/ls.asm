...
fmtname(char *path)
{
  ...
  6a:	b9a98993          	addi	s3,s3,-1126 # c00 <buf.0>
...
ls(char *path)
{
 ...
 128:	9f450513          	addi	a0,a0,-1548 # b18 <statistics+0xba>
 ...
 166:	98658593          	addi	a1,a1,-1658 # ae8 <statistics+0x8a>
 16a:	4509                	li	a0,2
 ...
 17c:	98858593          	addi	a1,a1,-1656 # b00 <statistics+0xa2>
 180:	4509                	li	a0,2
 ...
 1ae:	97e50513          	addi	a0,a0,-1666 # b28 <statistics+0xca>
 ...
 1f2:	952a0a13          	addi	s4,s4,-1710 # b40 <statistics+0xe2>
        printf("ls: cannot stat %s\n", buf);
 1f6:	00001a97          	auipc	s5,0x1
 1fa:	90aa8a93          	addi	s5,s5,-1782 # b00 <statistics+0xa2>
...
main(int argc, char *argv[])
{
 ...
 2bc:	89850513          	addi	a0,a0,-1896 # b50 <statistics+0xf2>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 62e:	58e50513          	addi	a0,a0,1422 # bb8 <digits>
 632:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ee:	476c8c93          	addi	s9,s9,1142 # b60 <statistics+0x102>
 ...
 6fc:	4c0b8b93          	addi	s7,s7,1216 # bb8 <digits>
 ...
 822:	33a98993          	addi	s3,s3,826 # b58 <statistics+0xfa>
        while(*s != 0){
 826:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 904:	2f87b783          	ld	a5,760(a5) # bf8 <freep>
 ...
 92c:	00e6ea63          	bltu	a3,a4,940 <free+0x4a>
{
 ...
 96e:	28f73723          	sd	a5,654(a4) # bf8 <freep>
}
 972:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9a0:	25c53503          	ld	a0,604(a0) # bf8 <freep>
 ...
 9c8:	23490913          	addi	s2,s2,564 # bf8 <freep>
  if(p == (char*)-1)
 9cc:	5afd                	li	s5,-1
 9ce:	a895                	j	a42 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 9d0:	00000797          	auipc	a5,0x0
 9d4:	24078793          	addi	a5,a5,576 # c10 <base>
 9d8:	00000717          	auipc	a4,0x0
 9dc:	22f73023          	sd	a5,544(a4) # bf8 <freep>
 9e0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a04:	1ea73c23          	sd	a0,504(a4) # bf8 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 a78:	15c50513          	addi	a0,a0,348 # bd0 <digits+0x18>
 a7c:	00000097          	auipc	ra,0x0
 a80:	b02080e7          	jalr	-1278(ra) # 57e <open>
  if(fd < 0) {
 ...
 a9e:	abc080e7          	jalr	-1348(ra) # 556 <read>
 ...
 ab2:	ab8080e7          	jalr	-1352(ra) # 566 <close>
  return i;
}
 ab6:	8526                	mv	a0,s1
 ...
 acc:	11858593          	addi	a1,a1,280 # be0 <digits+0x28>
 ad0:	4509                	li	a0,2
 ...
 ae0:	a62080e7          	jalr	-1438(ra) # 53e <exit>
