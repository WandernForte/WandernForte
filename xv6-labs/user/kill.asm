...
main(int argc, char **argv)
{
  ...
  4c:	83058593          	addi	a1,a1,-2000 # 878 <statistics+0x88>
  50:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 480:	41cc8c93          	addi	s9,s9,1052 # 898 <statistics+0xa8>
 ...
 48e:	466b8b93          	addi	s7,s7,1126 # 8f0 <digits>
 ...
 5b4:	2e098993          	addi	s3,s3,736 # 890 <statistics+0xa0>
        while(*s != 0){
 5b8:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 696:	29e7b783          	ld	a5,670(a5) # 930 <freep>
 ...
 6be:	00e6ea63          	bltu	a3,a4,6d2 <free+0x4a>
{
 ...
 700:	22f73a23          	sd	a5,564(a4) # 930 <freep>
}
 704:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 732:	20253503          	ld	a0,514(a0) # 930 <freep>
 ...
 75a:	1da90913          	addi	s2,s2,474 # 930 <freep>
  if(p == (char*)-1)
 75e:	5afd                	li	s5,-1
 760:	a895                	j	7d4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 762:	00000797          	auipc	a5,0x0
 766:	1d678793          	addi	a5,a5,470 # 938 <base>
 76a:	00000717          	auipc	a4,0x0
 76e:	1cf73323          	sd	a5,454(a4) # 930 <freep>
 772:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 796:	18a73f23          	sd	a0,414(a4) # 930 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 80a:	10250513          	addi	a0,a0,258 # 908 <digits+0x18>
 80e:	00000097          	auipc	ra,0x0
 812:	b02080e7          	jalr	-1278(ra) # 310 <open>
  if(fd < 0) {
 ...
 830:	abc080e7          	jalr	-1348(ra) # 2e8 <read>
 ...
 844:	ab8080e7          	jalr	-1352(ra) # 2f8 <close>
  return i;
}
 848:	8526                	mv	a0,s1
 ...
 85e:	0be58593          	addi	a1,a1,190 # 918 <digits+0x28>
 862:	4509                	li	a0,2
 ...
 872:	a62080e7          	jalr	-1438(ra) # 2d0 <exit>
